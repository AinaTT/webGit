 ...
 <div id="ocultomovil">
     <div id="ocultomovilinterno">
         <div id="menuidiomasmovil">
             <ul>
                 <li> <a class="activo" href="../microcement">Microcement</li>
             </ul>
         </div>
         <div id="menuocultomovil">
             <ul>
                 <li><a href="../microcements/products" onclick="ocultarmovil()">Products</a></li>
                 <li><a href="../professionals" onclick="ocultarmovil()">Professionals</a></li>
                 <li><a href="../microcements/microcement-application-courses" onclick="ocultarmovil()">Courses</a></li>
                 <li><a href="../microcements/gallery" onclick="ocultarmovil()">Gallery</a></li>
                 <li><a href="../news" onclick="ocultarmovil()">News</a></li>

             </ul>
         </div>
           <div id="menuidiomasmovil">
             <ul>
                 <li> <a href="https://www.topciment.com/en-us/"> <img src="https://www.topciment.com/imagenes/flags/usa.png" alt="Topciment  usa web" Title="Topciment usa web"> </a></li>
