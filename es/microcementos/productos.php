...
<body id="productos">
    ...
    <div id="main">
        ...
        <div class="container text-white">
            ...
            <!-- Start Sttandard -->
            <h1 class="en2s">SISTEMAS</h1>
            <div class="row altofam">
                <!-- Logo Sttandard -->
                <div class="col-md-5 col text-center">
                    <a href="productos/sttandard-microcemento-bicomponente.php"><img src="https://www.topciment.com/imagenes/sistemas/1Sttandard_Generico_Web.png" alt="Microcemento bicomponente" title="Microcemento bicomponente" class="text-center img-fluid"></a>
                </div>
                ...
                <div class="col-md-2">
                    <div class="row mb-2">
                        <div class="col-md-12 col-4 p-0">
                            <a href="productos/sttandard-microcemento-bicomponente.php#sttandard-microbase" class="vermas2">
                                <strong>Microbase</strong></a><br>
                            <a href="productos/sttandard-microcemento-bicomponente.php#sttandard-microfino" class="vermas2">
                                <strong>Microfino</strong></a>
                        </div>
                        <div class="col-md-12 col-4 p-0">
                            <a href="productos/sttandard-microcemento-bicomponente.php#sttandard-microdeck" class="vermas2"><strong>Microdeck</strong></a> <br>
                            <a href="productos/sttandard-microcemento-bicomponente.php#sttandard-microstone" class="vermas2">
                                <strong>Microstone</strong></a>
                        </div>
                        <div class="col-md-12 col-4 p-0">
                            <a href="productos/sttandard-microcemento-bicomponente.php#sttandard-acricem" class="vermas2">
    ...
    <div class=" col-md-5 col-12">
            ...
            <div class="row altofam">
                ...
                <div class="col-md-5 col-12">
                    <h2 class="sh2">Pintura metálica natural y óxido</h2>
                    <p class="textos">
            ...
            <div class="row altofam">
                ...
                <!-- Description Elitte -->
                <div class="col-md-5 col-12">
                    <h2 class="sh2">Efecto metálico y veladuras</h2>
                    <p class="textos">
        ...
        <div class="container text-white">
            ...
            <div class="row altofam">
                ...
                <div class="col-md-5">
                    <h2 class="sh2">Promotores de adherencia</h2>
                    <p class="textos">
                        Es la gama de imprimaciones de Topciment. Se trata del conjunto de productos que
                        forman parte del proceso previo a la aplicación del microcemento, facilitando y optimizando
                        la unión entre
                        el
                        soporte existente y el nuevo revestimiento.
            ...
            <div class="row altofam">
                ...
                <!-- Description Arcocem -->
                <div class="col-md-5 col-12">
                    <h2 class="sh2">Pigmentos</h2>
                    <p class="textos">
                        Es la línea de pastas pigmentarias compuesta por 6 colores básicos (Arcocem
                        Basic) que
                        permiten crear infinidad de tonos y gamas cromáticas para conseguir acabados auténticos y
                        personalizados
                        (Arcocem Plus).
            ...
            <div class="row altofam">
                ...
                <div class="col-md-4 col-12">
                    <h2 class="sh2">Barnices</h2>
                    <p class="textos">
                        Topsealer es el conjunto de selladores de alta calidad, claves en el acabado y
                        durabilidad
                        de
                        la aplicación.
                    </p>
            ...
            <div class="row altofam">
                ...
                <div class="col-md-5 col-12">
                    ...
                    <p class="textos">
                        Productos altamente especializados para la limpieza y mantenimiento del
                        microcemento. Se
                        caracterizan por ser biodegradables y respetuosos con el medioambiente.
            ...
            <div class="row altofam">
                ...
                <div class="col-md-5 col-12">
                    ...
                    <p class="textos">
                        La solución de Topciment para dotar a los suelos de microcemento de un atractivo
                        brillo
                        natural y dar durabilidad a la superficie tratada.
                    </p>
                </div>
                <!-- Products Ceraciment -->
                <div class="col-md-2 col-12">
            ...
            <div class="row altofam">
                ...
                <div class="col-md-4 col-12">
                    <h2 class="sh2">Herramientas</h2>
                    <p class="textos">
                        Herramientas testadas por Topciment para una óptima aplicación del microcemento.
