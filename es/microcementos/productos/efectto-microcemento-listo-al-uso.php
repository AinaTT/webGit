...
<head>
    ...
    <meta name="description" content="El microcemento listo al uso Efectto Quartz de Topciment crea acabados continuos inigualables de alta decoración." />
    ...
    <meta property="og:description" content="El microcemento listo al uso Efectto Quartz de Topciment crea acabados continuos inigualables de alta decoración.">
...
<body id="familia">
    ...
    <div id="main">
                    ...
                    <div class="container">
                        <div id="sidebar" class="menuOculto menuMicrocementos stick">
                            <ul>
                                ...
                                <li>
                                    <h2><a class="bl" href="#que-es-efectto">¿Qué es Efectto Quartz?</a></h2>
                                </li>
                                <li>
                                ...
                                <li>
                                    <h2><a class="bl" href="#aplicacion">Aplicación</a></h2>
                                </li>
                                <li>
                                    <h2><a class="bl" href="#colores"> Colores</a></h2>
                                </li>
                                <li>
                        ...
                        <div class="content">
                            ...
                            <h1 class="en2">Microcemento listo al uso Efectto Quartz</h1>
                            <div class="text-justify">
                                <p>
                                    Efectto Quartz es la línea de microcemento listo al uso, que permite
                                    conseguir acabados continuos de alta decoración. Su exclusiva fórmula no
                                    contiene
                                    cementos que puedan producir retracciones imprevistas ni fisuras.
                                </p>

                                <p>Efectto Quartz está concebido para profesionales que buscan velocidad en la
                                    aplicación y evitar escombros. Por ello, es la elección ideal para obras en casas
                                    habitadas.</p>

                                <p>Es un revestimiento decorativo continuo de bajo espesor que, debido a su gran
                                    adherencia, se puede aplicar sobre prácticamente cualquier soporte, tanto en
                                    interior y exterior como en superficies verticales y horizontales.
                                </p>

                                <p>Está disponible en una amplia gama de colores y en cuatro granulometrías diferentes,
                                    que destacan por su aspecto natural. A diferencia de Sttandard o Evoluttion, el
                                    color es más homogéneo y conserva la textura propia del microcemento.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <!-- descripcion -->
                        <div class="col-md-6">
                            <p>Efectto Quartz Small Grain es la capa de terminación para el sistema de
                                paredes.
                                Se aplica en una sola mano después de dos capas de Efectto Quartz Big Grain.
                                <br>Tiene una granulometría máxima de 0,1
                            </p>
                    ...
                    <p><span><strong>Efectto Quartz Small Grain</strong> se presenta en cubos cónicos de plástico negro
                            de 17 y 6 kg. </span></p>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <!-- descripcion -->
                        <div class="col-md-6">
                            <p>Efectto Quartz Medium Grain es la capa de terminación para el sistema de suelos.
                                Se aplica en una sola mano después de Efectto Quartz Super Grain.
                                <br> Tiene una granulometría máxima de 0,2
                            </p>
                            <a class="links" href="https://www.topciment.com/fichas-tecnicas/Ficha_Tecnica_Efectto_ES.pdf" target="_blank"><span class="fa-stack">
                                    <i class="fa fa-file-pdf-o fa-stack-1x"></i>
                                </span>
                    ...
                    <!-- Tipos de cubos-->
                    <p class="en3">Tipos
                        de Efectto Quartz Medium Grain</p>
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <p class="en3">
                        Presentación</p>
                    <p><span><strong>Efectto Quartz Medium Grain</strong> se presenta en cubos cónicos de
                            plástico negro de 17 y 6Kg.</span></p>
                </div>
            </div>
        ...
        <section>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p>
                                ...
                                es el microcemento empastado de preparación
                                para el sistema de paredes Sobre este producto se aplica una capa de Efectto
                                Quartz
                                Small Grain.
                    ...
                    <p class="en3">
                        Presentación</p>
                    <p><span><strong>Efectto Quartz Big Grain</strong> se presenta en cubos
                            cónicos de plástico negro de 17 y 6 Kg.</span></p>
                </div>
            </div>
        </section>
        <!-- End big grain -->
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <!-- descripcion -->
                        <div class="col-md-6">
                            <p>Efectto Quartz Super Grain es la capa de preparación para el sistema de
                                suelos.
                                Sobre este producto se aplica una capa de Efectto Quartz Medium Grain.
                                <br> Tiene una granulometría máxima de 0,5
                            </p>
                            <a class="links" href="https://www.topciment.com/fichas-tecnicas/Ficha_Tecnica_Efectto_ES.pdf" target="_blank"><span class="fa-stack">
                                    <i class="fa fa-file-pdf-o fa-stack-1x"></i>
                                </span>
                    ...
                    <p class="en3">
                        Presentación</p>
                    <p><span><strong>Efectto Quartz Super Grain</strong> se presenta en cubos
                            cónicos de plástico negro de 17 y 6 Kg.</span></p>
                </div>
                    ...
                    <div class="stepfloor mt-5">
                        ...
                        <div class="ocultable" id="floor" style="display: block;">
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>Paso 5</strong><br>plicar mediante llana una
                                    capa de Efectto Quartz
        ...
        <section>
            ...
            <div class="container">
                <section class="content">
                    <h2 class="en2">
                        <span>Colores de Efectto</span><br>
                    </h2>
                    <div class="rowColor">
        ...
        <section id="preguntas-frecuentes">
            ...
            <div class="container">
                <div class=" content">
                    <h2 id="preguntasFrecuentesH1" width="100% !important"><span style="padding:5px;">Preguntas Frecuentes</span><br>
                    ...
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                        ...
                        <div style="font-size:16px;">
                            <p>Efectto Quartz es un revestimiento de alta decoración para
                                profesionales concebido para lograr diseños de alta decoración.</p>

                            <p>Efectto Quartz es un revestimiento decorativo continuo de bajo espesor que debido a su
                                gran adherencia se puede aplicar sobre azulejo, terrazo, enlucidos de yeso, cemento,
                                etc… Su aplicación artesanal se realiza en varias capas mediante llana. Es adecuado
                                para
                                aplicaciones en interior y exterior, en paramentos verticales y horizontales.</p>
                            <p>Efectto se puede utilizar solo o como complemento de, por ejemplo, la línea Sttandard ya
                                que tienen acabados, colores y texturas totalmente diferentes.</p>
                        </div>
                    ...
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                        ...
                        <div style="font-size:16px;">
                            <p>Antes de la aplicación de Efectto Quartz, será necesario preparar la superficie con una
                                imprimación.
                            </p>

                            <p>La aplicación de Efectto Quartz se realiza en varias capas mediante llana, tanto en
                                interior como en exterior, en superficies verticales y horizontales, siempre y cuando
                                estén niveladas y consolidadas.
                            </p>
                            <p>Es importante que las capas sean finas de lo contrario se podrían producir grietas. Se
                                debe dejar 4 horas de secado entre capa y capa.</p>
                            <p>Una vez esté seco el producto, se debe sellar con Topsealer de acabado.</p>
                            <p><strong> Hay que tener en cuenta lo siguiente:</strong></p>
                            <ul>
                    ...
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                        ...
                        <div style="font-size:16px;">
                            <p>Es necesario nivelar la superficie con Efectto Super Grain si hay juntas. Si las juntas
                                son demasiado anchas se tendrá que utilizar un mortero de reparación de baja
                                retracción.
                            </p>
                        </div>
                    ...
                    <!-- Start Question Faq   -->
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                                ¿Qué gama de colores tiene Efectto?
                            </strong> </a>
                        <div style="font-size:16px;">
                            <p>Efectto Quartz tiene una amplia colección de colores y posibilidades cromáticas según la
                                aplicación sea en suelos o paredes.

                                <a href="https://www.topciment.com/colores.html"> Consulte nuestro catálogo de colores
                                    para ver nuestras gamas.</a>No cambia si se utiliza en suelo o paredes, sino qué
                                tipo de microcemento se utiliza.
                            </p>
                        </div>
                    ...
                    <!-- Start Question Faq -->
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                                ¿Efectto viene pigmentado?
                            </strong> </a>
                        <div style="font-size:16px;">
                            <p>No, el producto sólo se puede adquirir pigmentado a partir de la compra 1000 kg de
                                material, de lo contrario el pigmento se compra por separado. </p>
                            <p>Para pigmentar Efectto, se
                                puede hacer de manera manual vigorosamente y se
                                debe verter la totalidad del pigmento en el cubo y agitarlo hasta conseguir una mezcla
                                homogénea.</p>
                        </div>
                    ...
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                        ...
                        <div style="font-size:16px;">
                            <p>No se puede utilizar malla ya que es un producto decorativo pensado para aplicar en capa
                                fina. Es muy importante respetar siempre
                                los tiempos de secado para alcanzar sus máximas prestaciones.
                            </p>
                        </div>
                    ...
                    <!-- Start Question Faq -->
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                                ¿Qué puede ocurrir si pongo malla?
                            </strong> </a>
                        <div style="font-size:16px;">
                            <p>Para este tipo de producto no está indicado el uso de malla. en el caso de que se haya
                                utilizado necesitaremos una capa más gruesa de producto para poder cubrirla, afectando
                                al tiempo de secado y a su dureza, además de aumentar el riesgo de fisura.
                            </p>
                            <p>
                                Efectto no lleva cemento, hecho de resinas, por lo que tiene menor retracción, es más
                    ...
                    <!-- Start Question Faq -->
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                                ¿Cómo preservar la calidad del producto sobrante una vez finalizado el trabajo?
                            </strong> </a>
                        <div style="font-size:16px;">
                            <p>Es recomendable poner un plástico pegado al producto para evitar que el material esté en
                                contacto con el aire. Haciendo esto el material se conservará perfectamente sin perder
                                sus propiedades.</p>
                        </div>
                    ...
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                        ...
                        <div style="font-size:16px;">
                            <p>Efectto tiene un año de garantía desde su fecha de producción. Si no se siguen los
                                sistemas de aplicación
                                correctamente el producto perderá su garantía.</p>
                        </div>
                    ...
                    <!-- Start Question Faq -->
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                                ¿Sobre qué soportes puede aplicarse Efectto Quartz?
                            </strong> </a>
                        <div style="font-size:16px;">
                            <p>Efectto Quartz puede aplicarse tanto en soportes verticales como horizontales. Se
                                puede aplicar
                                sobre azulejo, terrazo, enlucidos de yeso, cemento, etc.</p>
                        </div>
                    ...
                    <!-- Start Question Faq -->
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                                ¿Dónde puede utilizarse Efectto Quartz?
                            </strong> </a>
                        <div style="font-size:16px;">
                            <p>Efectto es un material muy resistente que puede aplicarse tanto en interiores como
                                exteriores, además de en zonas húmedas como pueden ser cuartos de baños e incluso dentro
                                de las duchas. El proceso de sellado es clave para que el producto funcione
                                perfectamente en todas estas situaciones.</p>
                        </div>
                    ...
                    <!-- Start Question Faq -->
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                                ¿Es Efectto Quartz impermeable?
                            </strong> </a>
                        <div style="font-size:16px;">
                            <p>Efectto por sí mismo no es impermeable. Para conseguir una total impermeabilización es
                                necesario aplicar el sellador al final. Gracias al sellador, el material se puede
                                aplicar en todo tipo de superficies.</p>
                        </div>
                    ...
                    <!-- Start Question Faq -->
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                                ¿Cómo se limpia Efectto Quartz?
                            </strong> </a>
                        <div style="font-size:16px;">
                            <p>Para asegurar una vida útil y duradera de nuestros microcementos, te recomendamos el uso
                                de los productos de limpieza y cuidado del microcemento Topciment: limpiador Ecoclean y
                                cera de mantenimiento Ceraciment, tal como se indica en este pdf >> Guía de limpieza y
                                cuidado del microcemento Topciment o agua y jabones neutros.</p>
                        </div>
                    ...
                    <div style="border-top:thin solid #000; padding:10px 0; font-size:22px; text-align:left;"><a href="javascript:MostrarOcultar('texto1_4');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>
                        ...
                        <p style="font-size:16px;">Sí, pero antes de aplicarlo deberemos realizar el <strong>protocolo
                                de encendido</strong> de la calefacción para evitar que las fisuras producidas por los
                            cambios de temperatura en la solera se reproduzcan en el microcemento.</p>
