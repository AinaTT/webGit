 ...
 <div id="ocultomovil">
     <div id="ocultomovilinterno">
         <div id="menuidiomasmovil">
             <ul>
                 <li> <a href="../microcementos/microcementos.php">Microcemento</li>
                 <li><a class="activo" href="hormigon-impreso/hormigon-impreso.php">Hormigón</li>
         ...
         <div id="menuocultomovil">
             <ul>
                 ...
                 <li><a href="cursos-aplicacion-hormigon-impreso.php" onclick="ocultarmovil()">Cursos</a></li>
