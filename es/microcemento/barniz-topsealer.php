                    ...
                    <div class="container">
                        <div id="sidebar" class="menuOculto menuMicrocementos stick">
                            <ul>
                                ...
                                <li>
                                    <a href="#all-in-one"> Topsealer WT All in One</a>
                                </li>
                                <li>
                        ...
                        <div class="content">
                            ...
                            <div class="text-justify">
                              <p>
                                  Topsealer es la línea de selladores de Topciment diseñados para la protección de múltiples soportes como microcemento, parquet, madera, hormigón impreso o metales, entre otros.

                              </p>    
<p>
    Disponemos de una gran variedad de barnices de poliuretano en función del material que se quiera proteger y del acabado que se busque lograr. Selladores de inmejorables resistencias mecánicas y químicas como a la abrasión, al agua, al rayado, a las manchas, a la luz solar y ultravioleta o a los productos de limpieza agresivos.

</p>    
<p>
    Los barnices Topsealer se pueden aplicar tanto en interiores como exteriores y, además, son capaces de crear superficies antideslizantes e impermeables. Contamos con todo tipo de selladores: barnices de poliuretano al agua, barnices de poliuretano al disolvente, barnices de poliuretano 100% sólidos, barnices de poliuretano acrílicos e incluso barnices de poliuretano con pistola.
...
<p>
    Topsealer WT One Coat es un barniz poliuretano al agua bicomponente que se emplea para preservar y proteger el microcemento.

</p>    
<p>
    Este barniz al agua que facilita la limpieza y mantenimiento del microcemento, presenta elevadas resistencias al desgaste, a la abrasión y arañazos, a los productos químicos, a la suciedad y al amarilleamiento.

</p>    
<p>
    El sellador poliuretano Topsealer WT One Coat es apto para aplicar en múltiples soportes: metales, pavimentos de hormigón impreso y cemento, parquet y madera.

</p>    
<p>
    En cuanto a los acabados que ofrece este barniz de poliuretano, encontramos barniz mate o supermate; barniz satinado y barniz brillante.
                    ...
                    <p class="en3">
                        Presentación</p>
                    <p>El barniz poliuretano al agua bicomponente Topsealer WT One Coat se presenta en envases de 5 L (Componente A) + 1 L (Componente B)</p>
...
<p>
    Topsealer WT Anti Slip es un barniz poliuretano al agua antideslizante y con acabado mate cuya función principal es la de convertir las superficies en antideslizantes.

</p>    
<p>
    Este sellador poliuretano bicomponente es especialmente recomendable para proteger el microcemento, aunque puede utilizarse también sobre pavimentos de hormigón y para la renovación de parquets.

</p>    
<p>
    Gracias a sus buenas resistencias químicas y mecánicas, el barniz al agua Topsealer WT Anti Slip se puede aplicar en márgenes de piscinas, cuartos de baño y cocinas, suelos y pasillos de áreas comunes y rampas y pavimentos de hormigón.
                    ...
                    <p class="en3">
                        Presentación</p>
                    <p>El barniz poliuretano al agua antideslizante Topsealer WT Anti Slip se presenta en garrafas de 5 L (Componente A) + botella de 1 L (Componente B)
                    </p>
                </div>
            </div>
        </section>
...
<p>
    Topsealer WT Quick Dry es un barniz de poliuretano al agua de dos componentes e idóneo para la protección del microcemento.

</p>    
<p>
    Una de las características principales de este barniz de poliuretano al agua es que tiene un secado muy rápido. Además, este sellador de poliuretano presenta buenas resistencias a la abrasión y a los agentes químicos.
                    ...
                    <p class="en3">
                        Presentación</p>
                    <p>El barniz poliuretano al agua de secado rápido Topsealer WT Quick Dry se presenta en garrafas de 5 L (Componente A) + botella de 0,5 L (Componente B)
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                        <h2>
                              Barniz de poliuretano 100% sólidos impermeable

                        </h2>  
<p>
    Topsealer Pro + es un barniz de poliuretano 100% sólidos impermeable que no necesita imprimación. Este barniz incoloro está diseñado para aplicarse en una sola capa, ya que penetra completamente en los poros logrando un sellado completo.

</p>    
<p>
    Las principales singularidades de este sellador de poliuretano con acabado alto brillo son que impermeabiliza cualquier tipo de soporte y que otorga un extra de dureza al microcemento.

</p>    
<p>Existen dos tipos del barniz de poliuretano bicomponente Topsealer Pro + en función de la rapidez del secado: Fast y Slow.</p>
                            <a class="links" href="https://www.topciment.com/fichas-tecnicas/TopsealerPro+Fast_ES.pdf"
                                target="_blank"> <span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                                </span><strong>Descarga aquí la ficha
                                    técnica de Topsealer Pro +</strong>
                            </a>
                        </div>
                    </div>
                    <!-- Propiedades -->
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="  col-md-9">
                                    ...
                                    <p>Gracias a su alto contenido en sólidos </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="  col-md-9">
                                    ...
                                    <p> Fast:2,5 horas aproximadamente <br>
                                        Slow: 8 horas aproximadamente
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <p class="en3">
                        Rendimiento</p>
                    <p><span>Topsealer Pro+ Fast/Slow: Una mano de 150 g/m².
                        </span></p>
                    <!-- Presentación -->
                    <p class="en3">
                        Presentación</p>
                    <p>El barniz de poliuretano 100% sólidos impermeable Topsealer Pro + se presenta en un pack bicomponente de 0,64 kg (componente A) y 0,8 kg (componente B)
                    </p>
                </div>
            </div>
        </section>
...
<p>
    Topsealer DSV es un barniz poliuretano acrílico bicomponente (A + B) al disolvente. Este sellador protege las superficies recubiertas con microcemento en interiores y exteriores.

</p>    
<p>
    Este sellador poliuretano de dos componentes confiere buenas resistencias a la abrasión, al rayado, al agua, a la luz ultravioleta y a los agentes de limpieza domésticos.

</p>    
<p>
    Además, es un barniz acrílico que realza considerablemente el color de los revestimientos de microcemento, hormigón, madera o parquet. Los tres acabados de Topsealer DSV son: mate, brillo y satinado.
      
</p>                        
                            <a class="links" href="https://www.topciment.com/fichas-tecnicas/TopsealerDSV-ES.pdf"
                                target="_blank"> <span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                                </span><strong>Descarga aquí la ficha
                    ...
                    <p>El barniz poliuretano acrílico bicomponente al disolvente Topsealer DSV se presenta en un envase de 4 L (componente A) + dos envases de 1 L cada uno (endurecedor componente B)
                    </p>
                </div>
            </div>
        </section>
...
<p>
    Presealer es un sellador formulado a base de copolímero acrílico en emulsión e inalterable a la humedad. Por ello, es ideal para proteger "Atlanttic", el microcemento en piscinas.

</p>    
<p>
    Un barniz acrílico al agua que puede utilizarse como sistema de imprimación, ya que es capaz de actuar como puente de unión entre el microcemento y el acabado.
...
<p>
    Hay que aplicar dos capas de Presealer antes del Topsealer WT One Coat y Topsealer WT Anti Slip.
                            ...
                            <a class="links" href="https://www.topciment.com/fichas-tecnicas/Presealer-ES.pdf"
                                target="_blank"> <span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                                </span><strong>Descarga aquí la ficha
                                    técnica de
...
<p>
    Topsealer WT All in One es un barniz poliuretano al agua monocomponente desarrollado especialmente para la protección de nuestro microcemento listo al uso "Efectto". Aunque también puede aplicarse sobre microcemento epoxi, parquet o madera.

</p>    
<p>
    Este sellador de poliuretano realza considerablemente el color del microcemento listo al uso y proporciona elevadas resistencias mecánicas tanto al desgaste por abrasión como al rayado.

</p>    
<p>
    Presenta buenas resistencias químicas, siendo además impermeable frente al agua e inalterable a la luz ultravioleta. Disponible en mate y satinado.
                    ...
                    <p>
                       El barniz poliuretano al agua monocomponente Topsealer WT All in One se presenta en envases de 2 y 5 litros.</p>
                </div>
            </div>
        </section>
        <!-- end all in one -->
...
<p>
    Topsealer WT Spray es un barniz al agua con pistola diseñado para proteger las superficies recubiertas con microcemento u hormigón. Además de aplicarse con pistola a diferencia del resto de selladores de poliuretano, destaca por su extraordinaria durezca y por tener resistencias químicas y mecánicas mejoradas.

</p>    
<p>
    Este barniz de poliuretano bicomponente es muy recomendable para cocinas de microcemento y baños de microcemento. Aguanta perfectamente a la lejía, detergentes, manchas de vinagre, aceite, vino, grasas, etc.

</p>    
<p>
    Topsealer WT Spray es un barniz al agua con pistola que está disponible en brillo y que presenta buena resistencia a la abrasión, a los arañazos, a los agentes químicos, al agua, a los álcalis y que no amarillea bajo la acción de la luz solar.
                    ...
                    <p>El barniz poliuretano al agua con pistola Topsealer WT Spray se presenta en garrafas de 3 L (Componente A) + botella de 1 L (Componente B)
                    </p>
                </div>
            </div>
    </div>
