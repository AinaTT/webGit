                ...
                <section id="up">
                    ...
                    <div class="container">
                        <div class="content">
                            ...
                            <h1 id="queeselmicrocemento"><span style=" padding:5px;">Contáctanos</span></h1>
                        </div>
                        <div class="container">
                            <div class="content">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h2>Contacta directamente en:</h2>
                                        <p> Email: info@topciment.com<br>
                                            Teléfono: +34 963 925 989<br>
                                            Dirección: Calle Rosas 33, Manises 46940, Valencia</p>
                                    </div>
                                    <div class="col-md-6">
                                        <h2 style="font-size:26px"> Disponemos de aplicadores en las principales ciudades de España</h2>
