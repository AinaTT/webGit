...
<head>
    ...
    <link rel="canonical" href="https://www.topciment.com/en/microcements/resin-for-microcement-acricem" />
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <strong>Excellent penetration and stabilisation of the substrate</strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                <div class="col-md-3"><img
                                        ...
                                        class="figure-img img-fluid rounded" alt="icon" title="icon"></div>
                                <div class="col-md-9">
                                    <strong>Non-flammable, water-based</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-md-3"><img
                                        ...
                                        class="figure-img img-fluid rounded" alt="icon" title="icon"></div>
                                <div class="col-md-9">
                                    <strong>Can be applied by roller or brush in one coat
                                    </strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                <div class="col-md-3"><img
                                        ...
                                        class="figure-img img-fluid rounded" alt="icon" title="icon"></div>
                                <div class="col-md-9">
                                    <strong>The product is supplied ready for use
                                    </strong>
                                </div>
                            </div>
                        </div>
