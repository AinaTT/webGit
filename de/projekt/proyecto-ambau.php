...
<head>
    ...
    <link rel="canonical" href="https://www.topciment.com/de/projekt/proyecto-ambau" />
    <link rel="alternate" href="https://www.topciment.com/de/projekt/proyecto-ambau" hreflang="de-DE" />
...
<body id="proyecto">
    ...
    <div id="main">
        ...
        <div class="container">
            ...
            <div class="content">
                <h1 id="suelosDeMicrocementogalerieH1" class="wow fadeInLeft" style="width:100%">Gehäuse Pla del Real
                </h1>
                <h2 id="galerieH2" class="wow fadeInLeft justified">Valencia, Spanien.<br> Ambau Taller
                    d'Arquitectes.<br> Fotos: Ambau.</h2>
                <p><br>Ambau Taller d'Arquitectes.<br>
                    <p>Fotos: Ambau.</h2>
                        <p>Ambau Taller d'Arquitectes.
                            <div class="wow fadeInRight justificado"
                                style="float:left; font-size:16px; margin-left:0; margin-top:0;">
                                <p>Dieser Umbau durch Ambau Taller d'Arquitectes begann mit einer Prämisse: eine alte
