...
<head>
    ...
    <link rel="canonical" href="https://www.topciment.com/de/projekt/proyecto-clinica-hernandez-arquitectos" />

    <link rel="alternate" href="https://www.topciment.com/de/projekt/proyecto-clinica-hernandez-arquitectos"
        hreflang="de-DE" />
...
<body id="proyecto">
    ...
    <div id="main">
        ...
        <div class="container">
            ...
            <div class="content">
                <p id="suelosDeMicrocementogalerieH1" class="wow fadeInLeft" style="width:100%">Clínica dental Maria
                    Vazquéz</p>
                <h2 id="galerieH2" class="wow fadeInLeft justified">Valencia, Spanien.<br> Hernandez arquitectos.<br>
                ...
                <div class="wow fadeInRight justified" style="float:left; font-size:16px; margin-left:0; margin-top:0;">
                    <p>Die Exzellenz der Behandlungen der <strong>Doctor María Vázquez Clinic</strong> steht im Einklang
                        ...
                        erreicht wird. In dieser Art von Räumlichkeiten sind die Suche nach <strong>exquisiter
                            ...
                            target="blank">problemlos entsprechen</a>. Fotos von Germán Cabo.
                </div>
