                ...
                <section id="up">Mikrozementauftrag Schritt für Schritt: Anwendungsmethode
                    ...
                    <div class="container">
                        <div id="sidebar" class="menuOculto menuMicrocementos stick">
                            <ul>
                                <li><a href="#up" style="font-size:26px">Anwendung</a></li>
                                <li><a href="#suelos">Anwendung auf Fußböden</a></li>
                                <li><a href="#paredes">Anwendung an Wänden</a></li>
                                <li><a href="#piscinas">Anwendung in Schwimmbädern</a></li>
                        ...
                        <div class="content">
                            ...
                            <ul>
                                <li><a class="links" href="allgemeine-methoden-planung"
                                        target="_self">Anwendungsübersicht</a></li>
                                <li><a class="links"
                                        href="bedingungen-vor-bewerbung-und-unterstutzung-vorbereitung"
                                        target="_self">Bedingungen vor der Applikation und Untergrundvorbereitung</a>
                                </li>
...
<script type="application/ld+json">
{
  ...
  "@type": "CreateAction",
  "name": "Anwendung von Microcemento",
  "agent": {
    "@type": "Organization",
    "name": "Topciment",
