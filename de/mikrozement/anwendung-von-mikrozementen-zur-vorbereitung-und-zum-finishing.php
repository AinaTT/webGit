...
<head>
    ...
    <link rel="canonical"
        href="https://www.topciment.com/de/mikrozement/anwendung-von-mikrozementen-zur-vorbereitung-und-zum-finishing" />
            ...
            <div class="container">
                <div class="content">
                    ...
                    <p style="text-align:left;"> Es wird in zwei Schichten mit einem Stahlspachtel in Schichten von
                        ...
                        <strong>Schnellanleitung</strong> müssen unbedingt eingehalten werden.<br> Zwischen den
                        Anstrichen 24 Stunden trocknen lassen. Schleifen Sie jede Schicht ab, um Unregelmäßigkeiten mit
                        ...
                        <div id="mitadTextoIzquierda">
                            ...
                            <p><br>
                                ...
                                <img src="https://www.topciment.com/imagenes/aplicacion-de-microfino-1.jpg" width="100%"
                                    alt="aplicacion de microfino" title="aplicacion de microfino">
                            </p>
                            <h3>Auftragen von Microdeck</h3>
                            <p>Microdeck über Microbase in zwei Schichten mit einer flexiblen Stahlkelle auftragen.<br>
                                Die Mischungsverhältnisse der <strong>Schnellanleitung</strong><br> müssen immer
                                eingehalten werden. </strong><br> Bevor Sie die zweite Schicht auftragen, warten Sie 3
                                Stunden, bis die vorherige Schicht getrocknet ist und schleifen Sie sie leicht an.
                                Schleifen Sie von Hand oder mit einer Rotationsschleifmaschine mit 80er Körnung.
                                Überschreiten Sie bei Microdeck nicht die Auftragsstärke von 0,5 mm pro Schicht. Es wird
                                eine Gesamtsystemdicke von 2 bis 3 mm empfohlen.
                                <p>&nbsp;</p>
                                <p> <img src="https://www.topciment.com/imagenes/microdeck-en-suelos-con-llana-de-acero-biflex-1.jpg"
                                        width="100%" alt="microdeck en suelos con llana de acero biflex"
                                        title="microdeck en suelos con llana de acero biflex"></p>
                        </div>
                        <div id="mitadTextoDerecha" >
                            <h2>&nbsp;</h2>
                            <h3>Auftragen von Microstone</h3>
                            <p>Microstone wird in zwei Schichten mit einem flexiblen Stahlspachtel auf Microbase
                                aufgetragen. Für diese Art der Anwendung ist es ausreichend, den Untergrund mit einer
                                Schicht Microbase vorzubereiten. Wir müssen immer die Mischungsverhältnisse der
                                <strong>Schnellanleitung</strong> beachten. Verwenden Sie Schleifpapier der Körnung 40,
                                um Unregelmäßigkeiten zu beseitigen.<br> Überschreiten Sie bei Microstone nicht die
                                Auftragsstärke von 1 mm pro Schicht. Es wird eine Gesamtsystemdicke von 2 bis 3 mm
                                empfohlen.
                                <p>&nbsp;</p>
                                ...
                                <p>Aquaciment M wird in zwei Schichten mit einem flexiblen Stahlspachtel über Aquaciment
                                    XL aufgetragen. Die Mischungsverhältnisse der <strong>Schnellanleitung</strong></p>
                                <p>Wir verwenden Schleifpapier der Körnung 80, um Unregelmäßigkeiten zu beseitigen.</p>
                                <p>Bei Aquaciment darf eine Auftragsstärke von 1 mm pro Schicht nicht überschritten
                                    werden. Es wird eine Gesamtsystemdicke von 2 bis 3 mm empfohlen.
                        </div>
                </div>
            </div>
