...
<head>
    ...
    <link rel="alternate" href="https://www.topciment.com/de/mikrozement/verschiedene-effekte-auf-finish"
        hreflang="de-DE" />
    ...
    <div id="main">
        <div class="container">
            <div class="content">
                ...
                <h1 id="queeselmicrocemento"><span style=" padding:5px;">Verschiedene Finishing-Effekte </span><span
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div id="mitadTextoIzquierda">
                        <h2>Die Art der verwendeten Kelle</h2>
                        <p>Die Wahl der Art der Kelle wird entscheidend sein für das endgültige Aussehen der
                            Beschichtung, wir haben 2 Arten von Kellen: Gummikelle und flexible Stahlkelle. </p>
                        <p>Wir verwenden für Microfino ausschließlich Gummikellen, bei deren Einsatz das Wasser etwas
                            weniger ausgeprägt ist als bei der Stahlkelle. Die Gummikelle übt weniger Druck auf das
                            Produkt aus, so dass es feiner wird.</p>
                        <p>Auf der anderen Seite wird die Verwendung der flexiblen Stahlkelle empfohlen, wenn Sie einen
                            verbrannten Effekt oder schwarze Flecken wünschen.</p>
                    </div>
