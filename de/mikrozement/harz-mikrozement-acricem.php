                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <strong>Ausgezeichnete Penetration und Stabilisierung des Substrats</strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                <div class="col-md-3"><img
                                        ...
                                        class="figure-img img-fluid rounded" alt="icon" title="icon"></div>
                                <div class="col-md-9">
                                    <strong>Nicht brennbar, wasserbasiert</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-md-3"><img
                                        ...
                                        class="figure-img img-fluid rounded" alt="icon" title="icon"></div>
                                <div class="col-md-9">
                                    <strong>Es kann mit einer Rolle oder einem Pinsel in einer Schicht aufgetragen werden.
                                    </strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                <div class="col-md-3"><img
                                        ...
                                        class="figure-img img-fluid rounded" alt="icon" title="icon"></div>
                                <div class="col-md-9">
                                    <strong>Das Produkt wird gebrauchsfertig geliefert.
                                    </strong>
                                </div>
                            </div>
                        </div>
