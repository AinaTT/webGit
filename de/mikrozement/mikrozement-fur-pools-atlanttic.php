...
<head>
    ...
    <link rel="canonical" href="https://www.topciment.com/de/mikrozement/mikrozement-fur-pools-atlanttic"/>

     <link rel="alternate" href="https://www.topciment.com/de/mikrozement/mikrozement-fur-pools-atlanttic" hreflang="de-DE"/>
                    ...
                    <div class="container">
                        <div id="sidebar" class="menuOculto menuMicrocementos stick">
                            <ul>
                                ...
                                <li>
                                    <h2><a href="#que-es-atlanttic">Was ist Atlanttic?</a></h2>
                                </li>
                                <li>
                                    <h2><a href="#atlanttic-aquaciment">Atlanttic Aquaciment</a></h2>
                                </li>
                                <li>
                                    <h2> <a href="#aplicacion">Anwendung</a></h2>
                                </li>
                                <li>
                                    <h2><a href="#colores">Farben</a></h2>
                                </li>
        ...
        <section>
            <div class="container ">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="links" href="https://www.topciment.com/de/technische-datenblatter/atlanttic-aquaciment-DE.pdf" target="_blank" style="font-weight: 700;"> <span class="fa-stack">
                                ...
                                </span>Laden Sie hier das technische Datenblatt von
                                Atlanttic Aquaciment
                            </a>
                        </div>
                    </div>
                    <!-- Tipos de cubos -->
                    <p class="en3">Typen von Atlanttic Aquaciment</p>
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <strong> Kompressionswiderstand</strong>
                                    <p>55 N/m² (28 tage)
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <strong>Haftung auf dem Substrat
                                    </strong>
                                    <p>1,5 N/m²</p>
                                </div>
                            </div>
                    ...
                    <p class="en3">
                        Verpackung</p>
                    <p>Atlantic Aquaciment wird in konischen 20-kg-Eimern aus schwarzem Kunststoff geliefert.
                    </p>
                </div>
            </div>
        </section>
                ...
                <div class="content">
                   <!-- Aplicacion paredes -->
                    <div class="stepwalls mt-5">
                        <a class="text-dark en3" href="javascript:MostrarOcultar('wall');"><strong>+ SCHRITT
                                FÜR SCHRITT
                            </strong></a>
                        <div class="ocultable" id="wall" style="display: block;">
                            ...
                            <div class="row mt-5 ">
                                ...
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>Schritt 1</strong><br>Reinigen und Vorbereiten der Unterlage, wir müssen
                                    sicherstellen dass diese zusammenhängt, trocken ist und bei Bedarf miteinander
                                    verbunden wird. Staubsaugen, um Unterlage zu reinigen.

                                    <br> Eine Schicht Sttandard Acricem anwenden.
                                </div>
                                <!-- Icono -->
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>Schritt 2</strong><br>Eine erste Schicht Aquaciment XL ohne Pigment
                                    auftragen. Schleifen
                                </div>
                                <!-- Icono -->
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>Schritt 3</strong><br> Eine zweite Schicht Aquaciment XL mit Pigment
                                    auftragen. Schleifen
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img src="https://www.topciment.com/imagenes/atlanttic/stepbystep/llana.png"
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>Schritt 4</strong><br>Eine erste Schicht Aquaciment M mit Pigment auftragen.
                                    Schleifen
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img src="https://www.topciment.com/imagenes/atlanttic/stepbystep/llana.png"
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>Schritt 5</strong><br>Eine zweite Schicht Aquaciment M mit Pigment
                                    auftragen. Schleifen
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img src="https://www.topciment.com/imagenes/atlanttic/stepbystep/llana.png"
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>Schritt 6</strong><br>Zwei Schichten Pre-Sealer auftragen, um die Oberfläche
                                    zu schützen.<br>
                                    Lassen Sie 4 Stunden Trockenzeit zwischen den einzelnen Schichten.<br>
                                    Die Trockenzeit vor dem Füllen des Schwimmbads sollte mindestens 5 Tage betragen.
                                    </a>.
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img src="https://www.topciment.com/imagenes/atlanttic/stepbystep/roller.png"
