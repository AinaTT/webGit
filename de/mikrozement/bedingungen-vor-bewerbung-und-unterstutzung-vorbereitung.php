...
<head>
    ...
    <link rel="canonical"
        href="https://www.topciment.com/de/mikrozement/bedingungen-vor-bewerbung-und-unterstutzung-vorbereitung" />
    ...
    <link rel="alternate"
        ...
        hreflang="en-GB" />
    <link rel="alternate" href="https://topciment.com/pl/mikrocement/warunki-aplikacji-i-przygotowanie-podloza"
        hreflang="pl-PL" />
    ...
    <div id="main">
        <div class="container">
            <div class="content">
                ...
                <h1 id="queeselmicrocemento"><span style=" padding:5px;">Bedingungen vor der Applikation und
                        Untergrundvorbereitung</span><span style="background-color:#FFF; padding:5px;"></span></h1>
            </div>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <div id="mitadTextoIzquierda">
                        ...
                        <h3>Konsistenz.</h3>
                        <p>Die Auftragsgrundlage muss stabil sein. Untergründe mit pulverförmigen Mörteln oder losen
                        ...
                        <p>Wenn Feuchtigkeit im Untergrund vorhanden ist, können wir keinen mikrozement  auftragen. Es
                            ...
                            übersteigt.</p>
                        <p>Die Unterlage muss einen ausreichenden Abbindeprozess durchlaufen haben. Es ist zu
                            berücksichtigen, dass die Temperatur und die relative Luftfeuchtigkeit der Umgebung zusammen
                            mit der Belüftung des Arbeitsraums den Trocknungsprozess der Mörtel beeinflussen und den
                        ...
                        <h3>
                            <h3>Empfohlener Träger im Schwimmbadsystem</h3>
                            <p>Es wird auf Spritzbeton oder Spritzbeton aufgetragen, wobei der Träger sauber,
                                konsolidiert und in guten Bedingungen der Planimetrie ist. Es sollte nicht auf
                                Steingut angewendet werden.
                    ...
                    <div id="mitadTextoDerecha">
                        ...
                        <ul>
                            <li>Füllen Sie die Fugen mit Microbase und lassen Sie sie 24 Stunden lang trocknen. Wenn die
                                Fugen sehr dünn sind, können wir Microdeck oder sogar Microfino verwenden. </li>
                            <li> Tragen Sie eine Schicht Primacem PLUS mit der Rolle zusammen mit dem Builtex-Gitter
                                auf. </li>
                            <li> Lassen Sie mindestens 30 Minuten lang trocknen und tragen Sie die erste Schicht
                                Microbase auf. </li>
                            <li> 24 Stunden trocknen lassen, eine Schicht Primacem PLUS auftragen und die zweite Schicht
                                Microbase auftragen. </li>
                        </ul>
                        <h2>Hier sehen wir ein anderes Applikationssystem mit Impoxi</h2>
                        <li>
                            </ul>
                            ...
                            <ul>
                                <li>Die Acricem-Grundierung mit einer handelsüblichen Malerrolle auftragen.<br>
                                </li>
                        </li>
                        </li>
                        ...
                        <ul>
                            ...
                            <li>Abstauben mit 0,3-0,8 mm trockenem Quarzsand mit 1 kg/m2</li>
                            <li>Trocknen lassen für 24 Stunden</li>
                            <li>Überschüssigen Quarzsand durch Kehren und Absaugen entfernen</li>
                            <li>Impoxy mit 3 kg/m2</li>
                        </ul>
                        </ul>
                        <li>Impoxy mit 3 kg/m2</li>
                        </ul>
