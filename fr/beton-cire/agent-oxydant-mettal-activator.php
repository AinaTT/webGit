...
<body id="familia">
    ...
    <div id="main">
                ...
                <section id="up">
                    ...
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p class="en3" >
                                Rendements</p>
                            <p>En fonction du grade d'oxydation que vous désirez obtenir, la consommation peut varier
                                entre 13-15 m² par litre.
                            </p>
                            <!-- Presentación -->
                            <p class="en3" >
                                Présentation</p>
                            <p>Emballages de 400mL avec pulvérisateur. <br>
                                Emballages de 400 mL avec pulvérisateur. <br>
                                Bouteille de 1L sans pulvérisateur.</p>
        ...
        <section>
            <div class="container">
                <div class="contenedorMagenDerecha text-center">
                    <!-- logo -->
