...
<head>
    ...
    <link rel="canonical" href="https://www.topciment.com/fr/beton-cire/differents-effets-de-la-finition"/>
        ...
        <link rel="alternate" href="https://www.topciment.com/fr/beton-cire/differents-effets-de-la-finition" hreflang="fr-FR"/>
    <link rel="alternate" href="https://www.topciment.com/es/microcemento/diferentes-efectos-en-el-acabado" hreflang="es-ES"/>
...
<body id="familia">
    ...
    <div id="main">
        <div class="container clearfix">
            <div id="content">
                <section id="up" style="margin-top:135px;">
                    <a id="profesionales-microcemento" style="display: block; height: 60px; margin-top: -60px; visibility: hidden;"></a>

                    <div class="container">
                        <div class="content">

                            <h1 id="queeselmicrocemento" ><span style=" padding:5px;">Les différents effets de la finition </span><span style="background-color:#FFF; padding:5px;"></span></h1>
                        </div>
                        ...
                        <div class="container">
                            <div class="content">
                                ...
                                <h3 style="text-align:left; ;" >L'application de <a href="../information-beton-cire.html">béton ciré</a> est un
                                    ...
                                    comment obtenir les effets désirés.</h3>
                                <h2 style="text-align:left; ;" >Les différents effets dépendent de: </h2>

                                <div id="mitadTextoIzquierda" >
                                    <h2>Le type de truelle utilisée</h2>
                                    <p>Le choix du type de truelle sera déterminant pour l'aspect final; Il y a deux
                                        types de truelles: en caoutchouc et en acier flexible. Les
                                        truelles plates en caoutchouc sont utilisées exclusivement pour le Microfino,
                                        les filigranes sont légèrement moins prononcés qu'avec une truelle en acier. La
                                        truelle en caoutchouc exerce moins de pression sur le produit, ce qui rend la
                                        finition légèrement plus épaisse.<br>
                                    </p>
                                    <p>Au contraire, l'utilisation de la truelle en acier est conseillée uniquement dans
                                        les mains de professionnels expérimentés, car un excès de pression pourrait
                                        provoquer un effet brûlé et les eaux deviendraient sombres.</p>
                                ...
                                <div id="mitadTextoDerecha" >
                                    <h2>&nbsp;</h2>
                                    <img src="https://www.topciment.com/imagenes/marca-de-quemado-de-llana.jpg" width="100%" alt="Comment laisser la couche de base" title="Comment laisser la couche de base">
            ...
            <section id="mantenimiento">
                <div class="container">
                    <div class="content" style="text-align:left">
                        <h2>Comment laisser la couche de base</h2>
                        <p>
                        ...
                        <section id="mantenimiento">
                            <div class="container">
                                ...
                                <div id="mitadTextoDerecha" >
                                    <h2>&nbsp;</h2>
                                    <img src="https://www.topciment.com/imagenes/microcemento-fino-claro-oscuro-aguas.jpg" width="100%" alt="La méthode d’application" title="La méthode d’application">
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="mantenimiento">
                            <div class="container">
                                ...
                                <div id="mitadTextoDerecha" >
                                    <h2>&nbsp;</h2>
                                    <img src="https://www.topciment.com/imagenes/microbase-aplicada-fresco-sobre-fresco.jpg" width="100%" alt="microbase aplicada fresco sobre fresco" title="microbase aplicada fresco sobre fresco">
                                </div>
                            </div>
                        </section>
                        ...
                        <div class="wow fadeInRight" style="float:left; text-align:justify; font-size:16px; margin-left:0; margin-top:0;" >
                            ...
                            <br>
                            <iframe class="youtubefull" src="https://www.youtube.com/embed/5Bq21ESGs6c" frameborder="0" allowfullscreen></iframe>
