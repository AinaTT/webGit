...
<head>
  ...
  <link rel="canonical" href="https://www.topciment.com/fr/information-beton-cire"/>
    ...
    <div class="container">
      <div id="que-es-microcemento" class="content">
        ...
        <p>Un revêtement avant-gardiste, sans couture et adapté aux espaces extérieurs et intérieurs. Un revêtement
          ...
          locaux commerciaux et de grandes surfaces tels que des centres sportifs, des bâtiments industriels, des hôtels
          ou des restaurants.
        </p>
    ...
    <section>
      <div class="container">
        <div class="content">
          ...
          <div class="row">
            <div class="col-md-5">
              <a href="beton-cire/beton-cire-bicomposant-unlimitted" target="_blank"><img class="imgmicro img-fluid" src="https://www.topciment.com/imagenes/sistemas/logo_unlimitted_pagina_principal_92px_negro.png" alt="Logo Unlimitted microcemento bicomponente" title="Logo Unlimitted microcemento bicomponente"></a>
            </div>
            <div class="col-md-7">
          ...
          <div class="row">
            <div class="col-md-5">
              <a href="beton-cire/beton-cire-pour-piscines-atlanttic" target="_blank">
      ...
      <div class="container">
        <div class="content">
          ...
          <p><i class="fa fa-check"></i> Résistant à la circulation, aux chocs, aux rayures et aux produits chimiques.
          </p>
          <p><i class="fa fa-check"></i> Imperméable.</p>
          <p><i class="fa fa-check"></i> Antidérapant, selon les finitions.</p>
          <p><i class="fa fa-check"></i> Fonctionne rapidement sans débris.</p>
          <p><i class="fa fa-check"></i> Épaisseur du matériau 2/3 mm, donc cela n'affecte pas la charge structurelle du
            bâtiment.</p>
          <p><i class="fa fa-check"></i> Matériaux naturels. Produit 100% écologique.</p>
          <p><i class="fa fa-check"></i> Entretien et nettoyage faciles; avec du savon à pH neutre et de l'eau.</p>
      ...
      <div class="container">
        <div class="content">
          ...
          <p><a class="links" href="beton-cire/beton-cire-monocomposant-evoluttion#colores"><i class="fas fa-arrow-circle-right "></i> Découvrez ici toutes les couleurs <strong style="color:#e30514;">EVOLUTTION</strong> </a></p>
          <p><a class="links" href="beton-cire/beton-cire-pour-piscines-atlanttic#colores"><i class="fas fa-arrow-circle-right "></i> Découvrez ici toutes les couleurs <strong style="color:#4c86c3;">ATLANTTIC</strong> </a></p>

          <p> <a class="links" href="beton-cire/beton-cire-pret-a-lemploi-efectto#colores"><i class="fas fa-arrow-circle-right"></i> Découvrez ici toutes les couleurs <strong style="color:#e5007d;">EFECTTO</strong>
            </a> </p>

          <p><a class="links" href="beton-cire/revetement-metallique-pure-mettal#puremetal-aluminium"><i class="fas fa-arrow-circle-right "></i> Découvrez ici toutes les couleurs <strong style="color:#95969e;">PURE
                METTAL</strong> </a></p>
          <p><a class="links" href="beton-cire/peintures-metallique-classic-mettal#puremetal-aluminium"><i class="fas fa-arrow-circle-right "></i> Découvrez ici toutes les couleurs <strong style="color:#9c611b;">CLASSIC
                METTAL</strong> </a></p>
          <p><a class="links" href="beton-cire/glacis-et-pigments-metallique-elitte#elitte-glaze"><i class="fas fa-arrow-circle-right "></i> Découvrez ici toutes les couleurs <strong style="color:#ee7269;">ELITTE</strong>
            </a></p>
          ...
          <div class="card">
            ...
            <div id="collapse1" aria-labelledby="heading1" data-parent="#accordionExample" class="collapse show">
              <div class="card-body p-4">
                ...
                <p>
                  <a href="javascript:MostrarOcultar('texto1_1');" id="enlace1_1" style="color:#000; text-decoration:none;"><strong>+information</strong></a>
            ...
            <div id="collapse3" aria-labelledby="heading3" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                ...
                <div class="ocultable" id="texto1_4" style="text-align:left;font-size:16px;">
                  <p> <strong> Le protocole d’allumage sera le suivant : </strong> </p>
                  <p>1. Allumer le chauffage au moins 4 semaines après la mise en place du mortier de ciment.</p>
                  <p>2. Maintenir l’eau d’entrée dans les circuits à 25 ° pendant 2 ou 3 jours. Ensuite, augmenter
                  ...
                  <p> <strong> Les pavements de béton ciré doivent être appliqués </strong>  sur des mortiers
                    ...
                    climat. Quoi qu’il en soit, nous devons nous assurer que

                    le mortier est pratiquement sec. Pour ce faire, le support devra contenir un maximum de 5 %
                    d’humidité que nous vérifierons avec un

                    mesureur d’humidité relative.  </p>
                  <p>Nous recommandons d’utiliser des mortiers de ciment autonivelant de qualité. </p>
                  <p>Les supports à base de mortiers pulvérulents ne sont pas appropriés car l’état de la base
                  ...
                  <p>Changez toujours la température graduellement au début et à la fin de la période
                    d’utilisation du chauffage. </p>
                  <p>Assurez-vous que l’humidité relative de l’air dans les pièces ne soit pas trop basse. </p>
                  <p>
                    Évitez toujours l’accumulation de chaleur causée par les tapis et moquettes ou le manque
                    d’espace entre les meubles et le sol. </p>
                  <p> <strong> Important! </strong>  Entre le sol et les parements verticaux, il y aura toujours
                    un joint de dilatation pour qu’il puisse se dilater. Des

                    fissures pourraient apparaître si cette indication n’est pas respectée.</p>
              ...
              <div class="card-body p-4">
                ...
                <div class="ocultable" id="texto1_5" style="text-align:left;font-size:16px;">
                  <p>Selon le type de béton ciré et de texture, nous obtenons une plus ou moins grande résistance au
                    ...
                    apte aux sols.</p>
                  <p> Les différentes finitions pour sols et leurs textures. <br>
                    Les sols sont classés en fonction de leur valeur de résistance à la glissance, et de plus petite
                    à plus grande résistance il existe 3 classes, classe 1, 2 et 3.<br>Avec les bétons cirés
                    ...
                    surface à cause de sa texture.

                  </p>

                  <p> Finitions antidérapantes et classement selon leur glissance
                    Afin de limiter le risque de glissement, les sols des bâtiments ou des zones à usage Résidentiel
                    Public, Sanitaire, Enseignant, Commercial, Administratif et Fréquentation Publique, à
                    l’exclusion des zones d’occupation nulle définies dans l’annexe SI A du DB SI, auront une classe
                    appropriée conformément au point 3 de ce volet.
                    Les sols sont classés en fonction de leur valeur de résistance à la glissance Rd. Cette valeur
                    est déterminée moyennant l’essai du pendule décrit dans l’Annexe A de la norme UNE-ENV
                    12633:2003. Le Code Technique du Bâtiment (CTE) dans le document DB SUA-1 (Documents
                    Élémentaires pour la Sécurité d’Utilisation et Accessibilité) réglemente les taux de glissance
                    et détermine la classe que devra avoir un sol en fonction de son emploi. Le sol est plus
                    antidérapant à mesure qu’augmente la valeur Rd.
                    Les sols sont classés en fonction de leur valeur de résistance à la glissance Rd, conformément
                    aux dispositions de ce tableau : </strong>
                  </p>


                  <table width="50%" border="1" cellspacing="0" cellpadding="10">
                    <tr>
                      <th align="center" scope="col"> <strong> Resistencia al deslizamiento (Rd) </strong>
                      </th>
                  ...
                  <p><br>
                    <br>
                    <strong> Classe exigible aux sols en fonction de leur localisation et caractéristiques
                    </strong>
                    <br>Le tableau indique la classe que doivent avoir les sols, au moins, en fonction de leur
                    localisation. <br>
                    Cette classe sera maintenue pendant la vie utile du pavement
                    <br>
                    <strong> Zones intérieures sèches : </strong> <br>
                    Surfaces avec une pente inférieure à 6 % -> Classe 1<br>
                    Surfaces avec une pente égale ou supérieure à 6 % -> Classe 2<br>
                    <strong> Zones intérieures humides, comme les entrées aux bâtiments depuis l’espace
                      extérieur (1), terrasses couvertes, vestiaires, toilettes,

                      cuisines, etc. :
                    </strong> <br>
                    Surfaces avec une pente inférieure à 6 % -> Classe 2<br>
                    Surfaces avec une pente égale ou supérieure à 6 % -> Classe 3<br>
                    (1) Sauf quand il s’agit d’accès directs à des zones à usage restreint.<br>
                    <strong> Zones extérieures, piscines (2), douches -> Classe 3 </strong> <br>
                    (2) Dans les zones prévues pour des utilisateurs pieds-nus et au fond des vasques, dans les
                    zones où la profondeur ne dépasse pas 1,50 m.
                  </p>
                  <p style="font-size:16px; margin-bottom:5px">&nbsp;</p>
                </div>
          ...
          <div class="card">
            ...
            <div id="collapse6" aria-labelledby="heading6" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                ...
                <ul>
                  <li>Plus rapide et facile à appliquer.</li>
                  <li>Ne requiert pas d’équipements ni d’outils lourds pour l’installer.<br>
                  </li>
                  <li>Moins de travaux. Moindre coût. Moins de temps.<br>
                  </li>
                  <li>Plus léger, il n’y a donc pas de charges structurelles. <br>
                  </li>
                  <li>Emploi dans n’importe quelle pièce, pas seulement dans les rez-de-chaussée.<br>
                  </li>
                  <li>Ne requiert pas de joints, aucune fissure n’apparaît en séchant.<br>
                  </li>
                  <li>Il peut être appliqué aussi bien en tant que parement horizontal que vertical.</li>
                </ul><br>
                ...
                <div class="ocultable" id="texto1_6" style="text-align:left;font-size:16px;">
                  <p style="font-size:16px; margin-bottom:5px">
                    ...
                    composant aussi bien du mortier que du

                    béton qui agit de conglomérant. Le mortier est obtenu en mélangeant du sable et de l’eau
                    avec le ciment et le béton est un mortier de ciment

                    auquel est ajouté du gravillon.
                  </p>
                  ...
                  <p> <strong> BÉTONS </strong> <br>
                    Aussi bien le <strong> béton poli </strong> que le <strong> béton projeté ou le béton
                      taloché </strong> , consistent dans une <strong> dalle de

                      béton armé sur laquelle est appliqué un traitement superficiel pour obtenir la finition
                      définitive. Ce sont des pavements </strong> discontinus,

                    s’agissant de dalles il faut des joints de dilatation pour éviter la fissuration. </p>

                  <div id="mitadTextoIzquierda">
                    <p> <strong> Béton taloché : </strong> dans le cas du <strong> béton taloché, </strong> il
                      faut réaliser un lissage mécanique avec des lisseuses ou

                      hélicoptères. 

                      <br> &nbsp;
                    </p> <img src="https://www.topciment.com/imagenes/hormigon-fratasado.jpg" alt="Béton taloché" width="100%">
                    <p></p>
                  </div>

                  <div id="mitadTextoDerecha">
                    <p> <strong> Béton projeté : </strong> pour le béton projeté, il faut réaliser un estampage
                      avec des moules. Les deux pendant le processus de

                      durcissement du béton.

                    </p> <img src="https://www.topciment.com/imagenes/cemento-hormigon-impreso.jpg" alt="Béton projeté " width="100%"><br>
                    <p></p>
                  </div>
                  ...
                  <div id="mitadTextoIzquierda">
                    <p> <strong> Béton poli : </strong> Le <strong> béton poli </strong> consiste à appliquer un
                      traitement superficiel pour obtenir la finition

                      définitive, mais sur le béton complètement séché. Cela consiste dans un processus
                      mécanique de  <strong> ponçage et de polissage moyennant

                        lequel est polie la surface avec un polissoir </strong> , à têtes de diamant, en
                      laissant visible la section des granulats qui composent le béton,

                      l’aspect final est similaire à celui du granito.

                    </p><br>
                    <p><img src="https://www.topciment.com/imagenes/hormigon-pulido-y-devastado.jpg" alt="béton poli" width="100%">
                    </p>
                  </div>
                  ...
                  <div id="mitadTextoDerecha">
                    ...
                    <p>Le <strong> béton ciré  </strong> est un mortier dont la granulométrie des granulats est
                      ...
                      ne fissure pas. Il adhère très bien à tout matériau, il est

                      appliqué à l’aide d’une truelle en acier ou en caoutchouc.
                    </p>
                    <p>
                      <strong> MORTIER </strong>
                    </p>
                    <p>Le <strong> mortier taloché  </strong> serait le lissage réalisé de forme manuelle à un
                      crépissage (couche

                      de mortier de plus ou moins 2 cm d’épaisseur employée pour revêtir un mur)
                    </p>
                    <br>
                    <img src="https://www.topciment.com/imagenes/microcemento-revestimiento-de-bajo-espesor.jpg" alt="mortier dont la granulométrie des granulats est plus fine," width="100%"><br>
                  </div>
                  <div style="float:none; clear:both;"></div>
                  <p>Sur ce tableau nous résumons les caractéristiques et comparons les différences, en plus des
                    possibles applications :</p>
                  <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Murs, plafonds et sols </td>
                        <td>2 - 3 mm</td>
                        <td>Ne nécessite pas de joints</td>

                        <td>0,01 Kn /m²</td>
                        <td>Rénovations sans décombres, couvrir carrelages, revêtements de meubles…</td>
                      </tr>
                      <tr>
                        <th> <strong> Béton

                            projeté ou ciment projeté</th>
                        <td>Traitement superficiel de la dalle de béton à l’état plastique</td>
                        <td>Sols</td>
                        <td>5 -10 cm</td>

                        <td>Maximum tous les 25 m2</td>
                        <td>(e=10 cm) 2,50 Kn /m²</td>
                        <td>Parcs ou promenades publiques. Avec des finitions rustiques simulant

                          la pierre.</td>
                      </tr>
                      <tr>
                        <th> <strong> Béton taloché ou ciment lissé</th>
                        <td>Traitement superficiel de la dalle de béton pendant le processus de
                        ...
                        <td>Avec
                          ...
                          finition lisse, pour parkings et grandes surfaces</td>
                      </tr>
                      <tr>
                        <th>Béton poli ou ciment poli</th>
                        <td>Traitement superficiel de la dalle de
                        ...
                        <td>Aspect très
                          ...
                          similaire à un granito. Finition lisse, pour sols de grandes surfaces.</td>
                      </tr>
                      <tr>
                        <th> <strong> Mortier taloché </strong> </th>
                        <td>Revêtement

                          du lissage manuel sur un crépissage</td>
                        <td>Murs et sols</td>
                        <td>2 cm</td>
                        <td>Maximum tous les 25 m2</td>
                        <td>(e=2 cm) 0,50 Kn /m²
            ...
            <div id="collapse7" aria-labelledby="heading7" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                ...
                <div class="ocultable" id="texto1_7" style="text-align:left;font-size:16px;">
                  <p>Il s’agit d’un revêtement qui est travaillé avec une  <strong> préparation </strong>
                    préalable de la surface, une  <strong> application du

                      matériau en différentes couches, </strong> et une protection finale avec un <strong>
                      agent de scellage. </strong> </p>
                  <p>Chaque couche de matériau a son temps d’exécution et de séchage. De plus, il faut faire
                    particulièrement attention à la première semaine

                    (après la fin du travail) vu qu’il acquerra progressivement toute sa dureté et résistance.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="collapse8" aria-labelledby="heading8" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                <p class="  m-0">
                  ...
                  ; il y a donc une marge suffisante pour ne pas

                  avoir à raboter les portes.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="card-body p-4">
                ...
                <div class="ocultable" id="texto1_9" style="text-align:left;font-size:16px;">
                  <p style="font-size:16px; margin-bottom:5px">Les soins du béton ciré sont similaires à ceux d’un
                    ...
                    surface exempte de pierres ou de gravier, qui en y marchant dessus peuvent rayer le
                  ...
                  <p>Le béton ciré atteint les qualités de dureté, résistance et étanchéité désirées, un mois
                    ...
                    semaines. Par exemple : ne pas accrocher de tableaux ou mettre des tapis.</p>

                  <p> <strong>Soins spéciaux</strong> </p>
                  <p>Les soins sont similaires à ceux prodigués au parquet en bois naturel. Eviter que le
                    revêtement soit détrempé et en contact prolongé avec l’humidité. Ne pas laisser des tapis et
                    serviettes mouillées, jardinière avec fuite d’eau. Maintenir la superficie libre de gravier,
                    sable, pour éviter de rayer le revêtement en marchant. Éviter les coups et le frottement
                    avec des objets durs ainsi que de trainer des objets lourds pour ne pas endommager la
                    surface. Lors du déplacement des meubles, ne les trainez pas utiliser la méthode: "lever et
                    poser". Les graviers et la poussière en excès sons des facteurs d’érosion. Il sera
                    nécessaire de protéger le revêtement de sol du mobilier (pattes métalliques, superficies
                    pointues), et des objets dont les superficies en contact avec le sol sont abrasives ou d’un
                    poids conséquent grâce à des patins de feutres ou des glisseurs. Les roues des meubles
                  ...
                  <p>Il est recommandé d’entretenir régulièrement les revêtements de béton ciré avec des cires
                    ...
                    caractéristiques du lieu. Si vous souhaitez obtenir un résultat plus professionnel, il est
                    recommandé d’appliquer le Ceraciment Pro. Il s’agit d’une cire de haute résistance avec une
                    finition métallique. Il conserve en plus l’aspect original des surfaces plus longtemps. Dans
                    le cas que vous n’avez pas ces produits, vous pouvez utiliser une autre cire acrylique, bien
                    qu’on ne peut pas garantir les mêmes résultats.</p>
                </div>
            ...
            <div id="collapse10" aria-labelledby="heading10" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                ...
                <div class="ocultable" id="texto1_4c" style="text-align: left; font-size: 16px;">
                  <p>Les pigments que nous utilisons pour fabriquer nos colorants sont d'origine minérale. Il est possible de distinguer au sein des pigments ceux d'origine minérale et ceux d'origine organique. Les pigments d'origine minérale sont ceux qui fonctionnent le mieux contre l'alcalinité du ciment.
                    Les pigments organiques (molécules contenant du carbone), ne sont pas stables à l'extérieur, finissent par se transformer en d'autres composés sans propriétés pigmentaires ou migrant vers la surface, de sorte que certains tons initiaux finissent par disparaître presque complètement après un certain temps. Les pigments inorganiques maintiennent généralement la stabilité dans les mortiers et les bétons.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div id="heading11" class="card-header bg-white shadow-sm border-0">
              <h3><a href="#" data-toggle="collapse" data-target="#collapse11" aria-expanded="false" aria-controls="collapse11" class="d-block position-relative collapsed     collapsible-link py-2">
                  11. Pourquoi pourrait-il y avoir des différences de luminosité entre l'échantillon et le travail en cours?</a></h3>
            </div>
          ...
          <div class="card">
            <div id="heading12" class="card-header bg-white shadow-sm border-0">
              <h3><a href="#" data-toggle="collapse" data-target="#collapse12" aria-expanded="false" aria-controls="collapse12" class="d-block position-relative collapsed     collapsible-link py-2">
                  12. Les couleurs peuvent-elles être combinées sur la même surface?</a></h3>
            </div>
          ...
          <div class="card">
            <div id="heading14" class="card-header bg-white shadow-sm border-0">
              <h3><a href="#" data-toggle="collapse" data-target="#collapse14" aria-expanded="false" aria-controls="collapse14" class="d-block position-relative collapsed     collapsible-link py-2">
                  14.Quel temps de séchage faut-il prévoir entre la première couche de scellant et la seconde?
                </a>
              </h3>
            </div>
            <div id="collapse14" aria-labelledby="heading14" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                <p class="  m-0">
                  Le temps de séchage entre les couches du scellant ou du vernis dépendra de plusieurs facteurs. Telles que les conditions météorologiques, le degré d'humidité relative, la température ambiante de la pièce, s'il s'agit d'un espace fermé et humide comme une salle de bain, si le soleil frappe directement, etc.
                </p>
                <p>Dans tous les cas, nous essaierons toujours en toutes circonstances de laisser le temps de séchage maximum possible entre les couches pour éviter la formation de taches blanches car la surface est encore humide. Le temps de séchage minimum entre les couches est de 4 heures pour le Presealer et de 24 heures pour le Topsealer.</p>
              </div>
            </div>
          </div>
          <!-- Pregunta 15 -->
          ...
          <div class="card">
            ...
            <div id="collapse16" aria-labelledby="heading16" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                ...
                <p>
                  Si vous avez besoin de plus d'informations avant de vous décider, n'hésitez pas à nous appeler ou à remplir <a class="links" href="contact">notre formulaire</a> Nous serons ravis de vous aider..
                </p>
              </div>
            </div>
          </div>
