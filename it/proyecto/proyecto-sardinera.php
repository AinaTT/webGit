...
<head>
    ...
    <title>Casa di lusso con microcemento </title>
    <meta name="description"
        content="Imponente casa con pavimenti in microcemento sul mare. Casa Sardinera del famoso architetto Ramón Esteve" />
...
<body id="proyecto">
    ...
    <div id="main">
        ...
        <div class="container">
            ...
            <div class="content">
                <p id="suelosDeMicrocementoGaleriaH1" class="img-fluid wow fadeInLeft" style="width:100%">Casa Sardinera
                </p>
                <h2 id="galeriaH2" class="img-fluid wow fadeInLeft justificado">Javea, Spagna. <br> Studio Ramón Esteve.
                    <br> Foto: Mariela Apollonio.</h2>
                <div class="img-fluid wow fadeInRight justificado"
                    style="float:left; font-size:16px; margin-left:0; margin-top:0;">
                    <p>Situata in cima a Cabo de la Nao e con le viste più impressionanti della Comunità Valenciana,
                        Casa Sardinera combina design, modernità e relax. Lo stile di <u><a
                                href="http://www.ramonesteve.com/" target="blank">Ramón Esteve Studio</a></u> si
                        proietta in questa casa con una finitura <strong>"Total White"</strong>, dove i
                        <strong>pavimenti di <a href="../microcemento">microcemento</a></strong> in <u>color avorio</u>
                        agiscono in armonia con il resto degli elementi.
                </div>
