    ...
    <div class="container">
      <div id="que-es-microcemento" class="content">
        ...
        <p>El <strong>microcemento Topciment</strong> es un revestimiento decorativo compuesto a base de cemento,
          resinas base agua,
          aditivos y pigmentos minerales que puede aplicarse en multitud de <strong>superficies verticales y
            horizontales
        ...
        <p>Un recubrimiento a la vanguardia, <strong>sin juntas</strong> e idóneo tanto para espacios exteriores como
          interiores. Un
          revestimiento continuo <strong>aplicable en suelos, paredes, escaleras, techos, piscinas e incluso
            mobiliario.</strong> Su
          versatilidad ha conducido a que cada vez esté más presente en las reformas de viviendas particulares y en
          locales comerciales y grandes superficies como polideportivos, naves industriales, hoteles o restaurantes.</p>
        ...
        <p>
          Se acabaron las reformas complicadas. Con el microcemento Topciment <strong>cualquier combinación y estilo es
            posible</strong> . Estamos deseando ayudarte y aconsejarte.
        </p>
      </div>
    ...
    <div class="container">
      <div class="content">
        ...
        <p>Sea cual sea la superficie a revestir con microcemento, en Topciment <strong>nos importa el resultado
          ...
          en nuestro afán de lograr un producto óptimo, polivalente y de calidad, que perdure en el tiempo y se adapte a
          las necesidades del mercado, hemos alcanzado el <strong>equilibrio entre dureza y flexibilidad</strong> .</p>

        <p>Y esto, ¿qué significa? Que nuestro microcemento permite abarcar cualquier superficie, por grande que sea,
          consiguiendo un <strong>pavimento continuo sin juntas ni fisuras</strong> . De este modo evitamos zonas de
          suciedad, facilitando
    ...
    <section>
      <div class="container">
        <div class="content">
          ...
          <p>Llevamos casi dos décadas escuchando a los profesionales del sector para conocer sus inquietudes y
            ...
            necesidades. Contamos con varios sistemas de microcemento y revestimientos decorativos en función de las
            exigencias de la obra y el efecto final que se busca.</p>
          ...
          <div class="row">
            ...
            <div class="col-md-7 my-auto">
              ...
              <p class="mt-2">Por un lado tenemos <strong style="color: #7e91a6;">STTANDARD</strong>, nuestro
                microcemento bicomponente tradicional aplicable tanto en suelos como paredes. Destaca por su robustez,
                versatilidad y capacidad de crear texturas inigualables.</p>
            </div>
          </div>
          <hr>
          <div class="row">
            ...
            <div class="col-md-7">
              <p class="mt-2">Por otro lado <strong style="color:#d9da23;"> UNLIMITTED</strong>, la nueva línea de
                microcemento bicomponente que mejora notablemente la trabajabilidad del material y las resistencias
                mecánicas finales. Además, reduce el efecto de quemado provocado por la llana de acero.
              </p>
            </div>
          </div>
          <hr>
          ...
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <p class="mt-2"><strong style="color:#4c86c3;">ATLANTTIC</strong> es nuestra exclusiva línea de
                microcemento para piscinas y otras superficies en constante contacto con el agua. Un microcemento
                bicomponente que ofrece acabado antideslizante en aquellas zonas tendentes a resbalones como la corona y
                zona exterior que rodea a la piscina de microcemento. </p>
            </div>
          </div>
          <hr>
          <div class="row">
      ...
      <div class="container">
        <div class="content">
          ...
          <h2>Ventajas del microcemento</h2>
          <p>El microcemento es un revestimiento decorativo que goza de <strong>grandes cualidades</strong> . A
            continuación, te hacemos
            un breve resumen de las principales ventajas del microcemento Topciment:</p>

          <p><i class="fa fa-check"></i> Múltiples acabados decorativos. </p>
          <p><i class="fa fa-check"></i> Superficie sin juntas.</p>
          <p><i class="fa fa-check"></i> Puede aplicarse en suelos, paredes, techos, piscinas y muebles. Espacios
          ...
          <p><i class="fa fa-check"></i> Antideslizante, según acabados.</p>
          <p><i class="fa fa-check"></i> Obras rápidas y sin escombros.</p>
          <p><i class="fa fa-check"></i> Espesor del material 2/3 mm, por lo que no afecta a la carga estructural del
            edificio.</p>
          <p><i class="fa fa-check"></i> Materiales naturales. Producto 100% respetuoso con el medioambiente.</p>
          <p><i class="fa fa-check"></i> Fácil mantenimiento y limpieza; con agua y jabón pH neutro.</p>
          <p><i class="fa fa-check"></i> Espacios libres de gérmenes y bacterias.</p>
      ...
      <div class="container">
        <div class="content acabados">
          ...
          <h2>Acabados de microcemento</h2>
          <p>Los diferentes acabados de microcemento que se pueden obtener <strong>dependen de las texturas</strong>
            (ver tipos de
            microcemento) <strong>y los barnices o selladores empleados</strong>, ya que son dos elementos que
            condicionan el aspecto y
            acabado final de nuestros microcementos.</p>
          <p>Como el microcemento es un material poroso, es necesario aplicar un barniz o sellador que lo proteja de la
          ...
          <div class="row">
            ...
            <div class="col-md-11 my-auto">
              ...
              <p>Confiere un aspecto de lo más natural al revestimiento de microcemento. Apaga ligeramente el tono del
                color.</p>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-11 my-auto">
              ...
              <p>A medio camino entre el acabado mate y el acabado brillo. Es uno de los más solicitados por otorgar un
                aspecto moderno a la superficie.</p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-11 my-auto">
              ...
              <p>Realza y aviva el color. El efecto obtenido es marmoleado.</p>
            </div>
          </div>
          <div class="row">
            <div class="col-md-1"><img class="img-fluid acabado" src="https://www.topciment.com/imagenes/topsealer/Mate.jpg" alt="Acabado mate" title="acabado mate">
            ...
            <div class="col-md-11 my-auto">
              ...
              <p>Acabado mate pero con la condición de antideslizante. Se tiene que utilizar el barniz o sellador
                poliuretano Topsealer Anti Slip.</p>
            </div>
          </div>
      ...
      <div class="container">
        <div class="content">
          ...
          <h2>Colores microcemento</h2>
          <p>Contamos con una <strong>vasta carta de colores de microcemento</strong> . El sistema de pigmentación
            permite crear cualquier
            color a medida, personalizando así, estancias y ambientes para conseguir un estilo propio. </p>
          <p> <strong>Blanco, gris, verde, rojo, negro o azul son solo algunos</strong> de los múltiples colores de
            microcemento
        ...
        <div id="accordionExample" class="accordion shadow">
          ...
          <div class="card">
            ...
            <div id="collapse1" aria-labelledby="heading1" data-parent="#accordionExample" class="collapse show">
              <div class="card-body p-4">
                <p>Una de las particularidades del microcemento frente otros revestimientos decorativos es su elevada
                  resistencia y dureza. En los casos de Sttandard Microdeck, Sttandard Microstone y Evolution Microdeck
                  pueden incluso utilizarse en zonas de alto tránsito.</p>
                <p>Múltiples factores pueden influir en la resistencia y dureza de este recubrimiento, como por ejemplo:
                  el soporte sobre el que se aplicará el microcemento, el tipo de microcemento seleccionado o el
                  sellador, entre otros.</p>
          ...
          <div class="card">
            ...
            <div id="collapse2" aria-labelledby="heading2" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                ...
                <p>Se puede aplicar microcemento sobre casi cualquier tipo de soporte: mortero de cemento,
                ...
                <div class="ocultable" id="texto1_3" style="text-align:left;font-size:16px;">
                  ...
                  <p> <br>
                    ...
                    La preparación del soporte es tan importante como la aplicación de microcemento. Si el soporte no
                    reúne las condiciones necesarias no podremos aplicar el microcemento con garantías. La superficie
                    debe estar nivelada, consolidada, exenta de suciedad y con un grado de humedad inferior al 5%.

                  </p>

                  <p>En el caso de que el soporte sobre el que se vaya a aplicar el microcemento sea un mortero, tendrá
                  ...
                  <p><strong>Microcemento sobre madera natural o en parquet</strong><br>
                    Los suelos de parquet o madera natural poseen gran cantidad de juntas, las tablas dilatan en
                    diferentes
                    direcciones provocando tensiones difíciles de controlar, que pueden provocar fisuras en el
                    revestimiento,
                    por lo que no son aptos para aplicar microcemento directamente sobre ellos. En estos casos es
                    necesario
          ...
          <div class="card">
            ...
            <div id="collapse3" aria-labelledby="heading3" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                <p class="  m-0">Cada vez más personas se decantan por instalar calefacción por suelo radiante. Pero,
                  ¿puede aplicarse microcemento sobre suelo radiante? Sí, el microcemento se puede instalar sin
                  problemas en suelo radiante. Hay que realizar un protocolo de encendido de la calefacción para evitar
               ...
               <strong> <a class="links" href="noticia/microcemento-en-suelo-radiante">Saber más</a></strong> <br>
                ...
                <div class="ocultable" id="texto1_4" style="text-align:left;font-size:16px;">
                  ...
                  <p><strong>Los pavimentos de microcemento deben aplicarse</strong> sobre morteros cementosos que hayan
                    alcanzado una fase avanzada de fraguado. Esto ocurre transcurridas tres o cuatros semanas, en
                    función de
                    la climatología. En todo caso, debemos asegurarnos de que el mortero esté prácticamente seco. Para
                    ello
                  ...
                  <p>Evite siempre la acumulación de calor causada por alfombras y moquetas o la falta de espacio entre
                    los
                    muebles y el suelo.</p>
                  <p><strong>¡Importante!</strong> Entre la solera y los paramentos verticales siempre habrá junta de
                    dilatación para que esta pueda dilatar. En caso de no respetar esta indicación, podrían aparecer
                    fisuras.
                  </p>
          ...
          <div class="card">
            ...
            <div id="collapse4" aria-labelledby="heading4" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                <p class="  m-0">El microcemento no es impermeable por sí mismo, pero puede serlo si se utiliza un
                  sellador como terminación y aplicarse de esta manera el microcemento en lavabos, platos de ducha,
                  bañeras o zonas húmedas. En Topciment hemos creado el sellador Topsealer WT (barniz poliuretano al
                  agua), un sellador con el que garantizar la impermeabilidad del microcemento.</p>
              </div>
            </div>
          </div>
          <!-- Pregunta 5 -->
              ...
              <div class="card-body p-4">
                ...
                <div class="ocultable" id="texto1_5" style="text-align:left;font-size:16px;">
                  <p>Gracias al microcemento podemos conseguir cualquier superficie antideslizante. Dependiendo del tipo
                    de
                    microcemento y textura, se obtiene mayor o menor resistencia al deslizamiento (grado de
                    resbaladicidad).
                  ...
                  <p><strong>Los diferentes acabados para suelos y sus texturas</strong><br>
                    ...
                    clase <strong>1</strong> pero si se aplica simplemente una mano de tapaporos y una de poliuretano,
                    se
                    puede alcanzar la clase <strong>2</strong>. Si se emplea <strong>Microstone</strong> que contiene
                    partículas de árido más gruesas que el microcemento tradicional, se alcanza la
                    clase <strong>3</strong>.
                    La diferencia de textura se puede apreciar a simple vista.<br>
                    Hay que tener en cuenta las características antideslizantes de la superficie y dificultad de
                    limpieza. A
                  ...
                  <p><strong>Acabados antideslizantes y clasificación según su resbaladicidad</strong><br>
                    ...
                    <strong>Los suelos se clasifican, en función de su valor de resistencia al deslizamiento Rd, de
                      acuerdo
                  ...
                  <p><br>
                    ...
                    La tabla indica la clase que deben tener los suelos, como mínimo, en función de su
                    localización. <br>
                    ...
                    <strong>Zonas interiores húmedas, tales como las entradas a los edificios desde el espacio exterior
                      (1),
                    ...
                    (2) En zonas previstas para usuarios descalzos y en el fondo de los vasos, en las zonas en las que
                    la
              ...
              <div class="card-body p-4">
                ...
                <div class="ocultable" id="texto1_6" style="text-align:left;font-size:16px;">
                  <p style="font-size:16px; margin-bottom:5px">
                    ...
                    <br>
                    Hay que diferenciar entre, cemento, mortero de cemento, y hormigón. El cemento es un componente
                    tanto del
                    mortero como del hormigón que actúa de conglomerante. El mortero se obtiene al mezclar arena y agua
                    con
                  ...
                  <p><strong>HORMIGONES</strong><br>
                    Tanto el <strong>hormigón pulido</strong>, como el <strong>hormigón impreso, como el hormigón
                      fratasado</strong>, consisten en una <strong>losa de hormigón armado que se le aplica un
                      tratamiento
                  ...
                  <div id="mitadTextoIzquierda">
                    <p><strong>Hormigón fratasado:</strong> En el caso del <strong>hormigón fratasado</strong>, se
                      realiza
                  ...
                  <div id="mitadTextoDerecha">
                    <p><strong>Hormigón impreso:</strong> Mientras que en el <strong>hormigón impreso</strong> se
                      realiza un
                  ...
                  <div id="mitadTextoIzquierda">
                    <p><strong>Hormigón pulido:</strong> Por otro lado, el <strong>Hormigón pulido</strong> consiste en
                      aplicar un tratamiento superficial para conseguir el acabado final pero sobre el hormigón
                      totalmente
                      curado. Consiste en un proceso mecánico de <strong>devastado y pulido mediante el cual se lija la
                        superficie con pulidora</strong> con cabezas de diamante, dejando a la vista la sección de los
                      áridos
                  ...
                  <div id="mitadTextoDerecha">
                    ...
                    <p>El <strong>microcemento</strong> es un revestimiento que se aplica tanto en paredes como en
                      suelos,
                      tiene un espesor aproximado de entre 2 y 3 mm, no necesita juntas y no fisura. Se adhiere muy bien
                      a
                      cualquier material, se aplica mediante llana de acero o de goma. </p>
                    <p>
                      <strong>MORTERO</strong>
                    </p>
                    <p>El <strong>mortero fratasado</strong> sería el alisado que se realiza de forma manual a un
                      enfoscado
                    ...
                    <table width="100%" border="1" cellpadding="0" cellspacing="0">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Como máximo cada 25 m2</td>
                          <td>(e=10 cm) 2,50 Kn/m2</td>
                          <td>Aspecto muy similar a un terrazo. Acabado liso, ideal para suelos de grandes superficies.
                          </td>
                        </tr>
                        <tr>
          ...
          <div class="card">
            ...
            <div id="collapse7" aria-labelledby="heading7" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                <p class="  m-0">
                  Como el microcemento se adhiere al material ya existente las obras no son necesarias, por lo que los
                  trabajos con microcemento se pueden ejecutar en muy poco tiempo: entre tres y cinco días. En cambio,
                ...
                <div class="ocultable" id="texto1_7" style="text-align:left;font-size:16px;">
                  ...
                  <p>
                    Cada capa de material tiene su tiempo de ejecución y secado. Además hay que tener un cuidado
                    especial en
            ...
            <div id="collapse8" aria-labelledby="heading8" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                <p class="  m-0">
                  ...
                  espesor. <br>
                  Normalmente la holgura con la que se colocan las puertas es de 5 mm respecto del suelo; por lo tanto
                  hay
          ...
          <div class="card">
            ...
            <div id="collapse9" aria-labelledby="heading9" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                <p class="  m-0">
                  Una de las preguntas más frecuentes sobre este revestimiento decorativo es cómo limpiar el
                  microcemento. Aunque la limpieza del microcemento es sencilla y con agua y jabón neutro es más que
                ...
                <div class="ocultable" id="texto1_9" style="text-align:left;font-size:16px;">
                  ...
                  <p>Aunque el microcemento ofrece una alta resistencia a productos químicos, la limpieza del
                    microcemento debe hacerse con jabones neutros, nunca con productos agresivos ni desincrustantes.
                    Evitaremos los productos como el cloro, lejía, amoniaco, jabones y detergentes en general, pues
                    pueden dañar la película protectora.
                  </p>
                  <p><strong>Cuidados iniciales</strong></p>
                  <p>El microcemento alcanza los valores de dureza, resistencias químicas y estanqueidad deseables
                    <strong>un
                      mes después de su aplicación</strong>. El mayor riesgo de desperfecto está en las dos primeras
                    semanas.
                    Será transitable con mucho cuidado a los dos días del sellado de los pavimentos, y transitable con
                    toda
                    normalidad una semana después.
                  </p>
                  <p>Recomendamos evitar el arrastre de objetos pesados para no dañar la superficie. Para desplazar
                    muebles:
                  ...
                  <p>Aconsejamos mantener periódicamente los pavimentos de microcemento con Ceraciment o Ceraciment PRO
                    o
                    ceras acrílicas. La frecuencia del encerado dependerá del uso y de las características del lugar
                    (tránsito, polvo circundante, etc). Recomendamos el uso de mopas pasaceras para garantizar la
                    correcta
          ...
          <div class="card">
            ...
            <div id="collapse15" aria-labelledby="heading15" data-parent="#accordionExample" class="collapse">
              <div class="card-body p-4">
                <p class="  m-0">
                  <strong> El precio del microcemento varía en función de muchos factores.</strong> Solo un aplicador
                  profesional de este revestimiento decorativo puede decir con exactitud el precio por metro cuadrado de
                  este recubrimiento.
                </p>
                <p>
                  El desplazamiento de los profesionales, el tipo de microcemento seleccionado o el soporte sobre el que
                  se tenga que aplicar el microcemento son algunos de los factores que condicionarán el precio del m2
                  del microcemento. </p>
                <br> <strong> <a class="links" href="noticia/precio-del-microcemento">
                    Más información
                  </a></strong>
              </div>
            </div>
