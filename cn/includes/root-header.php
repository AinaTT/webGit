<div id="header" class="corto">
    <div class="menuBar" style="position:fixed; transform: translate3d(0px, 0px, 1px);">
        <div class="menuBarContent menu1a">
            ...
            <div class="menu botones menu1b">
                <ul>
                    ...
                    <li><a href="weishuini">微水泥</a>
                    </li>
                    <!--    <li><a href="epoxi">Epoxi</a></li> -->
                     <li class="submenu idiomas"><a href="#"><img src="https://www.topciment.com/imagenes/flags/china.png" alt="Topciment Chinese Web" Title="Topciment Chinese Web"></a>
                        <ul>
        ...
        <div class="menuBarContent menu2a">
            <div class="menu botones menu2b menu2bchino shadow  lg">
                <ul>
                    <li><a href="wenxingshuini/chanping">产品</a></li>
                    <li><a href="zhuanyerenshi">专业人士</a></li>
                    <li><a href="wenxingshuini/weishuiniyingyong-peixunkecheng">培训</a></li>
                    <li><a href="wenxingshuini/tuku">画廊</a></li>
                    <li><a href="xiaoxi">消息</a></li>
