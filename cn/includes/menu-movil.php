 ...
 <div id="ocultomovil">
     <div id="ocultomovilinterno">
         <div id="menuidiomasmovil">
             <ul>
                 <li> <a class="activo" href="../weishuini">微水泥</li>
             </ul>
         </div>
         <div id="menuocultomovil">
             <ul>
                 <li><a href="../wenxingshuini/chanping" onclick="ocultarmovil()">产品</a></li>
                 <li><a href="../zhuanyerenshi" onclick="ocultarmovil()">专业人士</a></li>
                 <li><a href="../wenxingshuini/weishuiniyingyong-peixunkecheng" onclick="ocultarmovil()">培训</a></li>
                 <li><a href="../wenxingshuini/tuku" onclick="ocultarmovil()">画廊</a></li>
                 <li><a href="../xiaoxi" onclick="ocultarmovil()">消息</a></li>

             </ul>
         </div>
         <div id="menuidiomasmovil">
             <ul>
                <li ><a href="#"><img src="https://www.topciment.com/imagenes/flags/china.png" alt="Topciment Chinese Web" Title="Topciment Chinese Web"></a></li>
                            <li> <a href="https://www.topciment.com/cn/"> <img src="https://www.topciment.com/imagenes/flags/spain.png" alt="Topciment Spanish Web" Title="Topciment Spanish Web"> </a></li>
