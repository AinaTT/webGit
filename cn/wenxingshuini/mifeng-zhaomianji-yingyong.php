                    ...
                    <div class="container">
                        <div id="sidebar" class="menuOculto menuMicrocementos stick">
                            <ul>
                                ...
                                <li>
                                    <a href="#que-es-topsealer">什么是 Topsealer?</a>
                                </li>
                                <li>
        ...
        <section>
            <div class="container">
                <div class="content">
                    ...
                    <p class="en3">
                        涂布率</p>
                    <p><span> TopSealer WT One Coat(2层) - 0,15 L/m²
                        </span></p>
                    <!-- 包装  -->
                    <p class="en3">
                        包装 </p>
                    <p> Topsealer WT One Coat罩面密封剂 有5L（A组分）+1L（B组分）的包装。</p>
        ...
        <section>
            <div class="container">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="links" href="https://www.topciment.com/cn/data-sheets/TopsealerWTantiSlip-CN.pdf"
                                target="_blank"><span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                                </span><strong>在此下载Topsealer WT防滑罩面剂的技术参数。</strong>
                            </a>
                        </div>
                    </div>
                    <!-- Propiedades  -->
                    ...
                    <p class="en3">
                        涂布率</p>
                    <p><span>Topsealer WT Anti Slip (2层) - 0,12 L/m²
                        </span></p>
                    <!-- 包装  -->
                    <p class="en3">
                        包装 </p>
                    <p>Topsealer WT防滑罩面剂 有5 L（A组份）和1L（B组份）的包装
                    </p>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="links" href="https://www.topciment.com/cn/data-sheets/TopsealerWTquickdry-CN.pdf"
                                target="_blank"><span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                                </span><strong>在此下载Topsealer WT快干清漆的技术参数</strong>
                            </a>
                        </div>
                    </div>
                    <!-- Propiedades -->
                    ...
                    <p class="en3">
                        涂布率</p>
                    <p><span>Topsealer WT快干清漆（2层）- 0.12升/平方米。
                        </span></p>
                    <!-- 包装  -->
                    <p class="en3">
                        包装 </p>
                    <p>Topsealer WT快干清漆有5 L（A组份）+0.5 L（B组份）的包装
                    </p>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="links" href="https://www.topciment.com/cn/data-sheets/Topsealer_All_in_one_CN.pdf"
                                target="_blank"> <span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                                </span><strong>在此下载Topsealer WT All in One多合一罩面剂的技术参数。</strong>
                            </a>
                        </div>
                    </div>
                    <!-- Propiedades -->
                    ...
                    <p class="en3">
                        涂布率</p>
                    <p><span> Topsealer WT All in One 多合一罩面剂- 0,2L/m2 (用3层)
                        </span></p>
                    <!-- 包装  -->
                    <p class="en3">
                        包装
