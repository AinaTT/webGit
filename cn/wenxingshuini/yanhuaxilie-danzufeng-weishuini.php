...
<head>
    ...
    <link rel="canonical" href="https://www.topciment.com/cn/wenxingshuini/yanhuaxilie-danzufeng-weishuini" />

    <link rel="alternate" href="https://www.topciment.com/cn/wenxingshuini/yanhuaxilie-danzufeng-weishuini"
        hreflang="zh-CN" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <strong> 密度</strong>
                                    <p>粉末中 - 1.175 ± 50Kg/m3<br>
                                       在浆糊中 - 1.545 ± 50Kg/m3<br>
                                       硬化 - 1.470 ± 50Kg/m3</p>
                                </div>
                            </div>
                        </div>
...
<p>
    在美学上，它是一种类似于石灰灰泥的涂料，不同的是它的表面处理比石灰灰泥更自然。
...
<p>
    Evoluttion Microfino系列墙面面层有3种颗粒度纹理：XS、S和M。
                            ...
                            <a class="links"
                                href="https://www.topciment.com/cn/data-sheets/Evoluttion_MicrofinoMN_CN.pdf"
...
<p>
    但是演化系列地面面层也可以应用于楼梯、淋浴板、水槽, 厨房台和墙壁。由于其中等颗粒度的质地，水印的效果比Evoluttion Microfino 演化系列墙面面层低。在美学上，这种单组分微水泥饰面与抛光水泥非常相似。
...
<p>
    Evoluttion Microdeck系列地面面层有两种颗粒度纹理：M和L。
                            ...
                            <a class="links"
                                href="https://www.topciment.com/cn/data-sheets/Evoluttion_MicrodeckMN_CN.pdf"
                                target="_blank" style="font-weight: 700;">
                                <span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                    ...
                    <p class="en3">
                        包装 </p>
                    <p>演化系列地面面层 Evoluttion Microdeck单组分微水泥，其耐性在室内地板中达到另一个水平，以20公斤的黑色塑料桶包装。</p>
                </div>
            </div>
        </section>
        <!-- end microdeck -->
 ...
 -->
                            <div class="row mt-5 ">
                                ...
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第1步
                                    </strong><br>将网格铺放在要涂抹的表面上，应用底漆Primacem Plus / ABS。
                                </div>
                                <!-- Icono -->
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第2步</strong><br>上第一层不含颜料的基础Microbase，抛光
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第6步</strong><br>用滚筒涂抹两层Presealer封孔剂。
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/sttandard/stepbystep/roller.png"
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第7步</strong><br>用滚筒涂抹两层Topsealer罩面剂。
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/sttandard/stepbystep/roller.png"
 ...
 -->
                            <div class="row mt-5 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第1步 </strong><br>将网格放在要涂抹的表面上。应用底漆Primacem Plus / ABS 。 </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/sttandard/stepbystep/roller.png"
                                        class="figure-img img-fluid rounded" alt="icon" title="icon"></div>
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第2步</strong><br>上第一层不含颜料的Microbase基础。
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/sttandard/stepbystep/llana.png"
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第3步</strong><br>上第二层带颜料的Microbase基础。
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/sttandard/stepbystep/llana.png"
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第4步</strong><br>上第一层带颜料的Microdeck演化系列地面面层。
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/sttandard/stepbystep/llana.png"
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第5步</strong><br>上第二层带颜料的Microdeck演化系列地面面层。
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/sttandard/stepbystep/llana.png"
