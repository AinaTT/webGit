...
<head>
    ...
    <title>双组分微水泥，具有更好的操作性 | 无局限系列 Unlimitted</title>
    <meta name="description" content="无局限系列双组份微水泥，是Topciment里具有更好可操作性的微水泥。它减少了烧焦的效果，并提供更平滑的饰面。" />


    <meta property="og:title" content="双组分微水泥，具有更好的操作性 | 无局限系列 Unlimitted">
    <meta property="og:site_name" content="Topciment">
    <meta property="og:url" content="https://www.topciment.com/cn/weishuini/unlimitted">
    <meta property="og:description" content="无局限系列双组份微水泥，是Topciment里具有更好可操作性的微水泥。它减少了烧焦的效果，并提供更平滑的饰面。">
    <meta property="og:type" content="article">




    <link rel="canonical" href="https://www.topciment.com/cn/wenxingshuini/wujuxian-zhuangzufeng-weishuini" />

    <link rel="alternate" href="https://www.topciment.com/cn/wenxingshuini/wujuxian-zhuangzufeng-weishuini"
        hreflang="zh-CN" />
    ...
    <link rel="alternate" href="https://www.topciment.com/fr/beton-cire/beton-cire-bicomposant-unlimitted"
        hreflang="fr-FR" />
    <link rel="alternate" href="https://topciment.com/pl/mikrocement/mikrocement-dwuskladnikowy-unlimitted"
        hreflang="pl-PL" />
...
<body id="familia">
    ...
    <div id="main">
                    ...
                    <div class="container">
                        ...
                        <div id="sidebar" class="menuOculto menuMicrocementos stick">
                            <ul>
                                ...
                                <li>
                                    <h2><a href="#que-es-unlimitted">什么是无局限 ？</a></h2>
                                </li>
                                <li>
                                    <h2><a href="#unlimitted-microbase">无局限的微水泥基础</a></h2>
                                </li>
                                <li>
                                    <h2><a href="#unlimitted-microdeck">无局限的微水泥面层</a></h2>
                                </li>
                                <li>
                        ...
                        <div class="content">
                            ...
                            <h1 class="en2">双组分微水泥，具有更好的操作性 | 无局限系列 Unlimitted</h1>
                            <div class="text-justify">

                                <p>
                                    无局限是Topciment公司的双组份微水泥（水泥和树脂）的新系列。它的主要特点是，大大改善了施工者对材料的可操作性。

                                </p>
                                <p>
                                    由于其创新的配方，无局限的最终机械阻力是卓越的。其最后饰面效果更柔和、更光滑，并拥有非凡的抗通行性。

                                </p>
                                <p>
                                    这种涂料的另一个特质是，使用钢质批刀涂抹材料可以减少产生的烧焦效果。它还具有与以石灰为基的砂浆相似的延展性。
                ...
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>
                                无局限系列的基础是无局限系列的双组分微水泥制备。应用在无局限的面层 S和无限制的面层 M之前使用。

                            </p>
                            <p>
                                在众多的饰面处理中，无局限给了专业人士乡村风格饰面处理的选择机会。这就是为什么这种涂料也可以作为双组分微水泥最后面层使用。

                            </p>
                            <p>
                                无局限的Microbase基础有3种颗粒度纹理。L，XL和XXL。

                            </p>


                            <a class="links"
                                href="https://www.topciment.com/cn/data-sheets/Unlimitted_Microbase_CN.pdf"
                                target="_blank" style="font-weight: 700;"> <span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                                </span>在这里下载无局限的Microbase基础技术参数。
                            </a>
                        </div>
                    </div>
                    <!-- Tipos de cubos -->
                    <p class="en3">无局限基础的双组分微水泥制备</p>
                    <div class="row">
                        <div class="col-md-4">
                            <figure class="figure"><img
                                    src="https://www.topciment.com/imagenes/unlimitted/Cubo_Unlimitted_Microbase_L.jpg"
                                    class=" img-fluid " alt="Unlimitted Microbase L" title="Unlimitted Microbase L">
                                <figcaption class=" text-center"> 无局限基础 Microbase L</figcaption>
                            </figure>
                        </div>
                        <div class="col-md-4">
                            <figure class="figure"><img
                                    src="https://www.topciment.com/imagenes/unlimitted/Cubo_Unlimitted_Microbase_XL.jpg"
                                    class=" img-fluid " alt="无局限基础 Microbase XL" title="无局限基础 Microbase XL">
                                <figcaption class=" text-center">无局限基础 Microbase XL </figcaption>
                            </figure>
                        </div>
                        <div class="col-md-4">
                            <figure class="figure"><img
                                    src="https://www.topciment.com/imagenes/unlimitted/Cubo_Unlimitted_Microbase_XXL.jpg"
                                    class=" img-fluid " alt="无局限基础 Microbase XXL" title="无局限基础 Microbase XXL">
                                <figcaption class=" text-center">无局限基础 Microbase XXL </figcaption>
                            </figure>
                        </div>
                    </div>
                    <!-- Propiedades -->
                    ...
                    <p class="en3">
                        涂布率</p>
                    <div class="row">
                        <div class="col-md-12"> 无局限基础 Microbase L（2层）：2.0 kg/m2</div>
                        <div class="col-md-12"> 无局限基础 Microbase XL (2层）：3,0 kg/m2 </div>

                        <div class="col-md-12"> 无局限基础 Microbase XXL （2层）：3,0 kg/m2 </div>

                    </div>
                    <!-- 包装  -->
                    <p class="en3">
                        包装 </p>
                    <p>无局限基础 Microbase双组分微水泥以 20公斤的黑色塑料桶包装
                    </p>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container ">
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a data-lightbox="texturas" data-title="Textura Unlimitted Microdeck M"
                                ...
                                <img class="img-fluid"
                                    src="https://www.topciment.com/imagenes/sttandard/texturas/AquacimentL.jpg"
                        ...
                        <div class="col-md-6">
                            ...
                            <h2>
                                无局限双组分微水泥面层 Microdeck

                            </h2>
                            <p>
                                Unlimitted Microdeck 作为双组分微水泥饰面使用。这种涂料可以应用于所有类型的可通行和不可通行的表面，在室内和室外都可以。

                            </p>
                            <p>
                                与传统微水泥系列 Sttandard Microdeck相比，无局限面层 Unlimitted
                                Microdeck具有更平滑的表面。此外，如果专业人员用钢质批刀涂抹，就不需要担心烧焦效果，因为不会产生。

                            </p>
                            <p>
                                若比较无局限面层Unlimitted Microdeck的2种颗粒度纹理，，Unlimitted Microdeck S比 Unlimitted Microdeck
                                M能确保更平滑的饰面，此外，它的干燥速度更慢，更容易覆盖。

                            </p>

                            <p>
                                无局限面层 Ulimitted Microdeck有两种颗粒度纹理：S和M。

                            </p>


                            <a class="links"
                                href="https://www.topciment.com/cn/data-sheets/Unlimitted_Microdeck_CN.pdf"
                                target="_blank" style="font-weight: 700;"> <span class="fa-stack">
                                    <i class="fas fa-file-pdf fa-stack-1x"></i>
                                </span>在此下载无局限面层 Ulimitted Microdeck技术参数
                            </a>
                        </div>
                    </div>
                    <!-- Tipos de cubos  -->
                    ...
                    <p class="en3">
                        包装 </p>
                    <p>无局限面层 Ulimitted Microdeck双组分微水泥以20公斤的黑色塑料桶包装。
                    </p>
                </div>
        </section>
        <!-- end microdeck -->
        ...
        <div class="fullscreen background parallax altoMovil centro"
            style="background-image:url('https://www.topciment.com/imagenes/unlimitted/background/Unlimitted_imagen_inerior_02_1920x1080.jpg'); "
            data-img-width="1920" data-img-height="1080" data-diff="100">
        </div>
 ...
 -->
                            <div class="row mt-5 ">
                                ...
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第1步
                                    </strong><br>将网格铺在要涂抹的表面上。<br>
                                    上底漆Primacem Plus/ABS。</a>
                                </div>
                                <!-- Icono -->
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第3步</strong><br>上第二层带颜料的Microbase 基础，抛光
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第7步</strong><br>用滚筒上两层Topsealer 罩面剂 <br>
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/sttandard/stepbystep/roller.png"
