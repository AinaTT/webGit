...
<head>
    ...
    <link rel="alternate" href="https://www.topciment.com/cn/wenxingshuini/jiyongxing-weishuini"
        hreflang="zh-CN" />
...
<body id="familia">
                    ...
                    <div class="container">
                        <div id="sidebar" class="menuOculto menuMicrocementos stick">
                            <ul>
                                ...
                                <li>
                                    <h2><a class="bl" href="#colores">颜色</a></h2>
                                </li>
                                <li>
                                    <h2><a class="bl" href="#preguntas-frecuentes-ok">常见问题</a></h2>
                                </li>
                            </ul>
                        </div>
                        <div class="content">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a class="links"
                                href="https://www.topciment.com/cn/data-sheets/Ficha_Tecnica_Efectto_CN.pdf"
                    ...
                    <div class="stepwalls mt-5">
                        ...
                        <div class="ocultable" id="wall" style="display: block;">
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto  -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第2步</strong><br>用滚筒上一层底漆 Primacem Plus/ABS。
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第6步</strong><br> 用滚筒上一层Topsealer WT 罩面剂，抛光
                                    <!-- 第7步 -->
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第7步</strong><br>用滚筒上一层Topsealer WT 罩面剂，抛光
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/efectto/stepbystep/roller.png"
 ...
 -->
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第2步</strong><br>用滚筒上一层底漆Primacem Plus/ABS
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/efectto/stepbystep/roller.png"
                            ...
                            <div class="row mt-3 ">
                                <!-- Texto -->
                                <div class="col-9 col-md-5 pasoapli">
                                    <strong>第7步</strong><br>用滚筒上一层Topsealer WT 罩面剂。
                                </div>
                                <!-- Icono -->
                                <div class="col-3 col-md-2"><img
                                        src="https://www.topciment.com/imagenes/efectto/stepbystep/roller.png"
...
<ul>
  <li>  切勿在天然木材或由碎片形成的基面上使用，因为它们可能会有不同程度的膨胀。 </li>
    
   <li> 基面必须巩固。 </li>
    
   <li> 表面必须是干燥的，没有灰尘和油脂。 </li>
    
  <li>  基面的平面测量将决定最终的呈现。 </li>
</ul>
...
<p>在开始使用前，有必要用机械搅拌器或手动方式大力搅拌，以使产品均匀化</p>
                        </div>
